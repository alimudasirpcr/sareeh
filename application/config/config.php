...
$branding_config = array(
	'phpsalesmanager' => 
		array(
			'name' => 'PHP App Sales Manager',
			'short_name' => 'PHP APP',
			'code' => 'phpsalesmanager',
			'domain' => 'phpsalesmanager.com',
			'staging_domain' => 'phpsalesmanagerstaging.com',
			'no_reply_email' => 'no-reply@mg.phpsalesmanager.com',
...
elseif(isset($_SERVER['HTTP_HOST']) && (strpos($_SERVER['HTTP_HOST'],'phpsalesmanager.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'php-app.net') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phpsalesmanagerstaging.com') !== FALSE))
{
	$brand = 'phpsalesmanager';	
}
else
{
	$brand = 'phpsalesmanager';	
