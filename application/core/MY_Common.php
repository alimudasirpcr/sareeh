...
function is_on_saas_host()
{
	...
	return isset($_SERVER['HTTP_HOST']) && (strpos($_SERVER['HTTP_HOST'],'phpsalesmanager.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'php-app.net') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phpsalesmanagerstaging.com') !== FALSE);
}
