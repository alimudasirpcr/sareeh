...
function get_suspended_sales_manage_table_list($items,$controller , $is_quick= false)
{
	$CI =& get_instance();
	$CI->load->model('Employee');
	...
	$table='<table class="table table-striped table-hover table-row-dashed data-table" id="sortable_table">';	
