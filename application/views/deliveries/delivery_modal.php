<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body ui-front" id="myTabModalBody">
			<div class="tab-content">
				<div class="tab-pane active" id="delivery-info">
					<div class="col-md-12">
						...
						<div class="form-group">
							<?php echo form_label(lang('deliveries_delivery_employee') . ':', 'delivery_employee_person_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
								<?php
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								<?php echo form_input(
									array(
										...
										'id' => 'tracking_number',
										'class' => 'form-control form-inps',
										'value' => $delivery_info['tracking_number'] ? $delivery_info['tracking_number'] : ($delivery_info['sale_id'] ? ($this->config->item('sale_prefix') ? $this->config->item('sale_prefix') : 'POS').''.$delivery_info['sale_id'] : '' )
									)
								); ?>
							</div>
						</div>
