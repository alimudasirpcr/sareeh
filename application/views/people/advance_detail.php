<div class="card shadow-sm mt-5">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="quantity-input">
                    <div class="form-check">
                        <?php echo form_label(lang('customers_amount_to_spend_for_next_point').':', '', array('class'=>'form-label wide')); ?>
            ...
            <div class="col-md-6">
                <div class="">
                    <div class="form-check">
                        <?php echo form_label(lang('points').':', 'points',array('class'=>'form-label ')); ?>
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label(lang('customer_saudi_tax_buyer_tax_id').' (ZATCA)'.':', 'zatca_buyer_tax_id', array('class'=>'form-label')); ?>
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label(lang('customer_saudi_tax_buyer_id').' '. '(ZATCA)'.':', 'zatca_buyer_id', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
										'name'=>'zatca_buyer_id',
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label(lang('customer_saudi_tax_buyer_scheme_id').' (ZATCA)'.':', 'zatca_buyer_scheme_id', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_street_name').' (ZATCA)'.':', 'zatca_buyer_party_postal_street_name', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_building_number') . ' (ZATCA)'.':', 'zatca_buyer_party_postal_building_number', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_postal_code'). ' (ZATCA)'.':', 'zatca_buyer_party_postal_code', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_city_name'). ' (ZATCA)'.':', 'zatca_buyer_party_postal_city', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_district_name') . ' (ZATCA)'.':', 'zatca_buyer_party_postal_district', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_plot').' (ZATCA)'.':', 'zatca_buyer_party_postal_plot_id', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_input(
									array(
        ...
        <div class="form-group zatca_buyer_info" style="display: none;">
            <?php echo form_label( lang('customer_saudi_tax_country_name') . ' (ZATCA)'.':', 'zatca_buyer_party_postal_country', array('class'=>'form-label')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
                <?php
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="py-5 mb-5">
                        <div class="form-check">
                            <?php echo form_label(lang('customers_tier_type').':', 'tier_id',array('class'=>'form-label ')); ?>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="py-5 mb-5 px-3">
                        <div class="form-check">
                            <?php echo form_label(lang('location').': ', 'location_id',array('class'=>'form-label')); ?>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="py-5 mb-5 px-3">
                        <div class="form-check">
                            <?php echo form_label(lang('customers_delete_cc_info').':', 'delete_cc_info',array('class'=>'form-label ')); ?>
                ...
                <div class="col-md-12">
                    <div class=" px-8">
                        <div class=" ">
                            <div class="mb-10">
                                <div class="form-check">
                                    <?php echo form_label(lang('customers_always_sms_receipt').':', 'always_sms_receipt',array('class'=>'form-label ')); ?>
