         ...
         <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px;">
            <tr>
               <td>
                  ...
                  ?>
                  <?php if($this->config->item('additional_appointment_note') || $location_info->additional_appointment_note){ ?>
                     <p><?php echo nl2br(make_marked_string_bold_italic_underline($this->Appconfig->replace_keywords_with_actual_word($location_info->additional_appointment_note ? $location_info->additional_appointment_note : $this->config->item('additional_appointment_note'), $appointment_data['location_id'] , $appointment_data['person_id'], $appointment_data['employee_id'] )));?></p>
                  <?php } ?>
