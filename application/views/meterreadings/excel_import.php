	...
	<div class="col-md-12">
		<div class="panel panel-piluku">
			<div class="panel-heading rounded rounded-3 p-5">
				...
				<?php echo form_open_multipart('meterreadings/do_excel_import/',array('id'=>'meterreading_form','class'=>'form-horizontal')); ?>
				<h3><?php echo lang('common_step_1'); ?>: </h3>
				<p><?php echo lang('meterreadings_step_1_desc'); ?></p>
				
				<ul class="list-inline">
					<li>
						<a class="btn btn-success btn-sm " href="<?php echo site_url('meterreadings/excel'); ?>"><?php echo lang('meterreadings_new_items_import'); ?></a>
					</li>
					<li>
						<?php echo lang('common_or');?>
					</li>
					<li>
						<a class="btn btn-success btn-sm " href="<?php echo site_url('meterreadings/excel_export'); ?>"><?php echo lang('meterreadings_update_items_import'); ?></a>
					</li>
				</ul>
					
				<h3><?php echo lang('common_step_2'); ?>: </h3>
				<p><?php echo lang('meterreadings_step_2_desc'); ?></p>
