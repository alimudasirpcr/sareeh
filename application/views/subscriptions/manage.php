				...
				<div class="pull-right-btn">
					...
					<div class="piluku-dropdown btn-group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li>
								<?php echo anchor("$controller_name/process_recurring_payments", '<span class="icon ti-loop"> '.lang($controller_name."_process_recurring_payments").'</span>',
										array('class'=>'process_payments','title'=> lang($controller_name."_process_recurring_payments"))); ?>
							</li>
							
							<script>
							$(".process_payments").click(function(e)
							{
								e.preventDefault();
								$.get($(this).attr('href'));
								bootbox.alert(<?php echo json_encode(lang('customer_subscriptions_processing'));?>);
							});
							</script>
