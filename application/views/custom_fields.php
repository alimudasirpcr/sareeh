                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-semibold mb-2"> <?= lang('name'); ?> </label>
                                            <!--end::Label-->
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-semibold mb-2"> <?= lang('type'); ?> </label>
                                            <!--end::Label-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-check ">
                                            ...
                                            <label class="form-check-label"
                                                for="<?php echo 'custom_field_'.$k.'_show_on_receipt';  ?>"><?php echo lang("show_on_receipt"); ?></label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="<?php echo 'custom_field_'.$k.'_hide_field_label';  ?>"><?php echo lang("hide_field_label"); ?></label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="<?php echo 'custom_field_'.$k.'_required';  ?>"><?php echo lang("required"); ?></label>
                                        </div>
                                ...
                                <div class="form-group" id="location_area_<?php echo $k;?>">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-8">
                                        <ul id="locations_list_<?php echo $k; ?>"
                                            class="list-inline d-flex justify-content-start">
                                            <?php
...
$("#save_custom_fields").ajaxForm({
    success: function() {
        show_feedback('success', <?php echo json_encode(lang('saved_successfully')); ?>,
