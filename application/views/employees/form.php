		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				...
				<?php echo form_label(lang('employees_acess_ip_range').':', 'employees_acess_ip_range',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
						<input id="allowed_ip_address" name='allowed_ip_address' value='<?php echo is_array($person_info->allowed_ip_address) ? implode(",", $person_info->allowed_ip_address) : $person_info->allowed_ip_address; ?>' placeholder=<?php echo json_encode(lang('employees_enter_ip'));?>; ?>
					</div>
				</div>
			</div>
		</div>
