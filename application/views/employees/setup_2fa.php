<div class="modal-dialog">
	<div class="modal-content customer-recent-sales">
		<div class="modal-header">
	        ...
	        <h5 style = "font-size: 20px;" class="modal-title"><?php echo lang('setup_two_factor_authentication'); ?></h5>
		</div>
		<div class="modal-body">
            <div class="text-center">
				<h3><?php echo lang('scan_code_with_your_authenticator_app'); ?></h3>
				<?= $qr_code ?>
				<h4><?php echo lang('enter_the_code_from_your_app_to_complete_setup'); ?></h4>
