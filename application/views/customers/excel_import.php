				        ...
				        <div class="col-xs-12">
				            <div class="col-md-12 well">
				                ...
				                <p class="text-center"><?php echo lang('upload_template'); ?>:</p>
					              ...
					              <li class="pull-right"><button id="step1_next_button" style="display:none" type="button" class="btn btn-primary next-step"><?php echo lang('next_step') ?> <span aria-hidden="true">&rarr;</span></button></li>
					            </ul>
										</nav>
				        </div>
				    </div>
				        ...
				        <div class="col-xs-12">
				            <div class="col-md-12 well">
				                ...
				                <p class="text-center"><?php echo lang('match_spreadsheet_columns_to_the_database_description'); ?></p>
					              ...
					              <li class="pull-right"><button id="step2_next_button" type="button" class="btn btn-primary next-step"><?php echo lang('next_step') ?> <span aria-hidden="true">&rarr;</span></button></li>
					            </ul>
										</nav>
				        </div>
				    </div>
				        ...
				        <div class="col-xs-12">
				            <div id="Complete" class="col-md-12 well text-center">
				                ...
				                <p class="text-center">
												...
												<button id="complete_import" class="btn btn-primary" action="<?php echo site_url('customers/complete_excel_import');?>"><?php echo lang('complete_excel_import') ?></button>
