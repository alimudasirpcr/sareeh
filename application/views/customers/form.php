...
<div class="row" id="form">
    ...
    <div class="col-md-12 ">
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <?php $this->load->view("people/form_sidebar", ['type' =>'customer' ]); ?>
...
$(document).ready(function() {
    // Generic function to apply Typed.js to elements with a specific class
    function applyTypedEffect(className) {
        $('.' + className).each(function() {
            var element = $(this);
            var text = element.text().trim(); // Get the existing text
            
            // Clear the text before the typing effect
            element.html('');
            
            // Apply Typed.js to each element
            new Typed(this, {
                strings: [text], // Use the text content dynamically
                typeSpeed: 50,
                backSpeed: 25,
                loop: false,
                showCursor: false
    ...
    // Call the function for elements with the class 'typed-text'
    applyTypedEffect('typed-text');
});
