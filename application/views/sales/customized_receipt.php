...
$(document).ready(function() {
    function updateVisibility() {
        ...
        function adjustTableBodies() {
            ...
            var originalLastFooter = $('.A4:last .page_footer')
            ...
            function applyFooterToLastPage() {
                var $lastPageFooter = $('.A4:last .page_footer');
            ...
            do {
                ...
                distributeBodies();
                removeEmptyPages();
                pages = $('.A4'); // Refresh the list of pages in case any were removed
            } while (changeMade);
...
<div class="preview_receipt">
    ...
    <div style="margin:0 auto; padding:0px !important; height:auto; <?php if ($receipt['background_image']) { ?> background-size: contain; background-position: center top;  
...
$items_per_page = $receipt['first_page_items'];  // Start with 3 items for the first page
$pages = [];
$current_page = [];
            ...
            <div class="row border-none row-cols-1 g-10   page_<?= $part; ?>"
                ...
                <div class="draggable        <?php  if(isset($positions_array[$part.'-'.$dynamic_name]) && $positions_array[$part.'-'.$dynamic_name]['display'] =='block'  ){ echo "already_shown"; }else { echo "already_hidden";} ?> <?= $part.'-'.$dynamic_name ?>"
                    ...
                    <ul class="list-unstyled ">
                        ...
                        <?php if (!empty($customer_company)) { ?><li>
                            <?php echo lang('company', '', array(), TRUE) . ": " . H($customer_company); ?></li>
                        <?php } ?>
                        <?php } ?>
                    </ul>
                    ...
                    <span class="add_top fw-bold"
                        style="position: absolute;  left:<?= $positions[$subtotal - 1]->newleft;  ?>; top:<?= $positions[$subtotal - 1]->newtop;  ?>;  text-wrap:nowrap;">
				...
				?>
                    ...
                    <div id="announcement-mobile" class="invoice-policy add_top">
                        <?php
											//hack to fix bug in html-2-canvas
