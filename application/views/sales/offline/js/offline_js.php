...
for (var k = 0; k < json.suppliers.length; k++) {
    ...
    supplier_item = '<li data-supplier_id="' + json.suppliers[k].id +
        '" class=" col-2 category_item supplier register-holder categories-holder nav-item mb-3 me-3 me-lg-6" role="presentation"><a class="  nav-link d-flex justify-content-between flex-column flex-center overflow-hidden  h-125px py-4 active" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1" aria-selected="true" role="tab"><div class="nav-icon"><img class="rounded-3 mb-4" alt="" src="' +
...
$(document).on("click", '#finish_sale_button', function(e) {
    ...
    bootbox.confirm(<?php echo json_encode(lang('sales_confirm_finish_sale')); ?>, function(result) {
        if (result) {
            ...
            var sale = JSON.parse(localStorage.getItem('cart')|| "{}"); 
          


            check_for_custom = sale.custom_fields;
