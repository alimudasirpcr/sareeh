				...
				<div class="card-body relative">
					...
					<div id="braintree_checkout">
						...
						<?php echo form_open('sales/finish_cc_processing/',array('id'=>'braintree_checkout_form','class'=>'form-horizontal', 'autocomplete'=> 'off'));  ?>
							...
							<input type="text" data-braintree-name="expiration_month" id="cc_exp_month" class="form-control" placeholder="<?php echo H(lang('month')); ?>">
							<input type="text" data-braintree-name="expiration_year" id="cc_exp_year" class="form-control" placeholder="<?php echo H(lang('year')); ?>">
							<input type="text" data-braintree-name="cvv" id="cc_cvv2" class="form-control" placeholder="CVV2">
							<input type="text" data-braintree-name="postal_code" id="zip" class="form-control" placeholder=<?php echo json_encode(lang('zip')); ?>>
