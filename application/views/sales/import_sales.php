			...
			<div class="panel-body">
			        ...
			        <div class="col-xs-12">
			            <div class="col-md-12 well text-center">
							...
							<a href="<?php echo site_url('sales/excel_template_for_new_sales') ?>" class="btn btn-primary"><?php echo lang('sales_new_sales_import'); ?></a>				
			            </div>
			        </div>
				        <div class="col-xs-12">
				            <div class="col-md-12 well">
				                ...
				                <p class="text-center"><?php echo lang('upload_template'); ?>:</p>
												...
												<div class="form-group">
													<?php echo form_open_multipart('sales/do_excel_upload_sale/',array('id'=>'item_form','class'=>'form-horizontal')); ?>
				        ...
				        <div class="col-xs-12">
				            <div id="Complete" class="col-md-12 well text-center">
				                ...
				                <p class="text-center">
												...
												<button id="complete_import" class="btn btn-primary" action="<?php echo site_url('sales/complete_excel_import_sale');?>"><?php echo lang('complete_excel_import') ?></button>
...
$.ajax({
    url: <?php echo json_encode(site_url('sales/get_database_fields_for_import_sale')); ?>,
    dataType: "json"
		    ...
		    paging: false,
		        ...
		        loadData: function() {
		            var d = $.Deferred();
								//add load indicator
		            $.ajax({
		                url: <?php echo json_encode(site_url('sales/get_uploaded_excel_columns_sale')); ?>,
		                dataType: "json"
		            }).done(function(response) {
									$.get(<?php echo json_encode(site_url('sales/do_excel_import_map_sale')); ?>);
										//remove spinner
		                d.resolve(response);
...
$("#complete_import").on("click", function(e){
  ...
  $.ajax({
      url: <?php echo json_encode(site_url('sales/set_excel_columns_map_sale')); ?>,
			data: {mapKeys: JSON.stringify($.map(column_map, function(v) { return v; }))},
			method: 'POST'
  }).done(function(response1) {
   
    $.ajax({
        url: <?php echo json_encode(site_url('sales/complete_excel_import_sale')); ?>,
		dataType: "json"
...
function display_import_errors(type)
{
  ...
  $.ajax({
      url: <?php echo json_encode(site_url('sales/get_import_errors')); ?>,
			dataType: "json"
