			...
			<div class="panel panel-piluku">
		      ...
		      <h3 class="panel-title"><i class="ion-android-clipboard"></i> <?php echo lang("common_inventory"); ?> <small>(<?php echo lang('common_fields_required_message'); ?>)</small></h3>
				...
				<div class="panel-body">
					...
					?>
					<div class="form-group">	
						<?php echo form_label(lang('items_allow_item_to_be_sold_online_even_if_out_of_stock').':', 'shopify_item_level_inventory_policy',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
