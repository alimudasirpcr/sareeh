...
<div class="d-flex flex-column  <?= ($invoice_info->invoice_id > 0)? 'flex-lg-row':''; ?>" data-select2-id="select2-data-189-65xj">
    <!--begin::Content-->
    ...
    <!--begin::Sidebar-->
    <div class="flex-lg-auto min-w-lg-300px  <?= ($invoice_info->invoice_id > 0)? :'hidden'; ?>" data-select2-id="select2-data-188-tiag">
        <!--begin::Card-->
