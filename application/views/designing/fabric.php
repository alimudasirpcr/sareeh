...
<?php if ($exchange_name === 'false') {
						...
						<div class="col-md-12" style="padding: 0px;">
							...
							<div class="card card-bordered">
								...
								<div class="card-header hidden-print">
                                    ...
                                    <button class="btn btn-primary" id="rect">Rect</button>
                                        <button class="btn btn-primary" id="circ">Circ</button>
 ...
 background-repeat: repeat-y; height:auto;  background-image: url(<?= $img_background_image; ?>)" <?php } ?>>
									...
									<div class="row row-cols-1 g-10  "  id="dropZone" style="height: 600mm;">
										<!--begin::Col-->
                                        <canvas  class="<?= $receipt['size'] ?>" width="700" height="900"  id="c" ></canvas>
...
//         html2canvas(element).then(function(tempCanvas) {
//             $("#"+$id).hide();
...
//             });
// });
// const myHtmlElement = document.querySelector('.draggable');
// document.addEventListener('DOMContentLoaded', (event) => {
//   const myHtmlElements = document.querySelectorAll('.draggable');

//   myHtmlElements.forEach(element => {
//     element.addEventListener('click', () => {
//       html2canvas(element).then(tempCanvas => {
//         const img = new fabric.Image(tempCanvas);
...
// myHtmlElement.addEventListener('click', () => {
//     console.log(myHtmlElement);
//   html2canvas(myHtmlElement).then(tempCanvas => {
//     // Convert the temporary canvas to a data URL
//     const dataUrl = tempCanvas.toDataURL();

//     // Create a Fabric Image from the data URL
//     fabric.Image.fromURL(dataUrl, (img) => {
//       // Add the Fabric Image to the Fabric Canvas
//       canvas.add(img);
//       canvas.renderAll();
//     });
//   });
