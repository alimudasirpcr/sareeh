...
<div class="row g-5 g-xl-10 mb-xl-10">
    ...
    <!--end::Col-->
      ...
      <!--begin::Col-->
      <div class="col-lg-4 col-xl-4 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_5">
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_5">
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6 summary-data">
                        <div class="card card-flush  mb-5 mb-xl-10">
                            ...
                            <div class="card-header p-1">
                                <!--begin::Title-->
                                <div class="card-title d-flex flex-column mx-3">
                                    <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2 counted sub_5">0</span>
                                    <span
                                        class="text-gray-400 pt-1 fw-semibold fs-6"><?= lang('Reports_Subtotal'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-flush  mb-5 mb-xl-10">
                            ...
                            <div class="card-header p-1">
                                ...
                                <div class="card-title d-flex flex-column mx-3">
                                    ...
                                    <span
                                        class="text-gray-400 pt-1 fw-semibold fs-6"><?= lang('Reports_Total'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-flush  mb-5 mb-xl-10">
                            ...
                            <div class="card-header p-1">
                                ...
                                <div class="card-title d-flex flex-column mx-3">
                                    ...
                                    <span
                                        class="text-gray-400 pt-1 fw-semibold fs-6"><?= lang('Reports_Profit'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--begin::Col-->
    <div class="col-lg-8 col-xl-8 col-xxl-6 mb-5 mb-xl-0">
        <!--begin::Chart widget 3-->
        <div class="card card-flush overflow-hidden h-md-100">
            <!--begin::Header-->
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_1">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_1">
      ...
      <div class="col-lg-4 col-xl-4 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_6">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_6">
    ...
    <div class="col-lg-8 col-xl-8 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_2">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_2">
    ...
    <div class="col-lg-4 col-xl-4 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_7">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_7">
    ...
    <div class="col-lg-8 col-xl-8 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_3">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_3">
      ...
      <div class="col-lg-4 col-xl-4 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_8">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_8">
    ...
    <div class="col-lg-8 col-xl-8 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_4">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_4">
    ...
    <div class="col-lg-4 col-xl-4 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_9">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_9">
    ...
    <div class="col-lg-8 col-xl-8 col-xxl-6 mb-5 mb-xl-0">
        ...
        <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card-header py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-color-gray-500 btn-active-color-primary justify-content-end" id="wo_10">
                        <i class="fas fa-chevron-up"></i>
                    </button>
                </div>
                <!--end::Title-->
            ...
            <!--end::Header-->
            <!--begin::Card body-->
            <div class="card-body d-flex justify-content-between flex-column pb-1 px-0 wo_10">
    ...
    <div class="row col-lg-12 " id="employee_donts">
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-4 mb-5 mb-xl-0 mt-4">
            <!--end::Col-->
            <div class="card card-flush overflow-hidden h-md-100">
            ...
            <div class="card card-flush overflow-hidden h-md-100">
                <div class="card-header py-5">
                    <h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-dark"
                            id="title_<?= $key; ?>"><a target="_blank" class="mb-1 text-dark text-hover-primary fw-bold"
                                href="<?php echo site_url('reports/generate/detailed_work_order'); ?>">
                                <?= lang($key); ?> </a> </span></h3>
                </div>
   ...
   ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-4 mb-5 mb-xl-0 mt-4">
            <div class="card card-flush overflow-hidden h-md-100">
                <div class="card-header py-5">
                    <h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-dark"
                            id="title_THIS_YEAR"><a target="_blank" class="mb-1 text-dark text-hover-primary fw-bold"
                                href="<?php echo site_url('reports/generate/detailed_work_order'); ?>">
                                <?= lang('employee_wise_current_location'); ?> </a> </span></h3>
                    <div class="card-toolbar">
                        <div id="reportrange"
			...
			?>
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    <div id="chart_wrapper_THIS_YEAR" class="overlay overlay-block">
                        <div id="work_orders_THIS_YEAR" style="height: 300px;"> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-4 mb-5 mb-xl-0 mt-4">
            <div class="card card-flush overflow-hidden h-md-100">
                <div class="card-header py-5">
                    <h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-dark"
                            id="title_status_wise_THIS_YEAR"><a target="_blank"
                                class="mb-1 text-dark text-hover-primary fw-bold"
                                href="<?php echo site_url('reports/generate/detailed_work_order'); ?>">
                                <?= lang('status_wise'); ?> </a> </span></h3>
                    <div class="card-toolbar">
                        <div id="reportrange_work_orders_status_wise_THIS_YEAR"
                            style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
                            <i class="fa fa-calendar"></i>&nbsp;
                            <span></span> <i class="fa fa-caret-down"></i>
                        </div>
...
if (count($authenticated_locations) > 0) { ?>
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    <div id="chart_wrapper_status_wise_THIS_YEAR" class="overlay overlay-block">
                        <div id="work_orders_status_wise_THIS_YEAR" style="height: 300px;"> </div>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    // Function to toggle visibility and icon, and store the state in localStorage
    function toggleContent(id) {
        var contentDiv = $("." + id);  // Target div with class matching the button ID
        var buttonIcon = $("#" + id + " i");  // Target the icon inside the button

        // Toggle the 'hidden' class
        contentDiv.toggleClass("hidden");

        // Change the icon and store the state in localStorage
        if (contentDiv.hasClass("hidden")) {
            buttonIcon.removeClass("fa-chevron-up").addClass("fa-chevron-down");  // Change to down arrow
            localStorage.setItem(id, "hidden");  // Store state as hidden
        } else {
            buttonIcon.removeClass("fa-chevron-down").addClass("fa-chevron-up");  // Change to up arrow
            localStorage.setItem(id, "visible");  // Store state as visible
        }
    }
    ...
    function loadState(id) {
        ...
        if (state === "hidden") {
            ...
            buttonIcon.removeClass("fa-chevron-up").addClass("fa-chevron-down");  // Down arrow if hidden
        } else {
            contentDiv.removeClass("hidden");
            buttonIcon.removeClass("fa-chevron-down").addClass("fa-chevron-up");  // Up arrow if visible
        }
    }

    // Add click event listeners for buttons dynamically
    $("[id^=wo_]").click(function() {
        var id = $(this).attr("id");  // Get the button ID (e.g., wo_1, wo_2)
        toggleContent(id);  // Toggle content and icon
    });

    // On page load, check localStorage and apply the saved state
    $("[id^=wo_]").each(function() {
        var id = $(this).attr("id");  // Get the button ID (e.g., wo_1, wo_2)
        loadState(id);  // Load state from localStorage
    });
});
    ...
    $(document).ready(function() {
        ...
        function load_chart(urls = 'graphical_summary_work_order', title, id, location,
            report_date_range_simple, company = 'All', compare = 'no') {
            var url = '';
            if (compare == 'no') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    colorPalette = [
                        '#008FFB', '#00E396', '#FEB019', "#FF0000", "#00FF00", "#0000FF",
                        "#FFFF00", "#FF00FF", "#00FFFF", "#FF4500", "#FF8C00", "#FFD700",
                        "#ADFF2F", "#32CD32", "#00FF7F", "#00FA9A", "#008B8B", "#000080",
                        "#4B0082", "#9400D3", "#8A2BE2", "#800080", "#7B68EE", "#483D8B",
                        "#000000", "#FFFFFF", "#FFA07A", "#FA8072", "#E9967A", "#F08080",
                        "#CD5C5C", "#DC143C", "#B22222", "#FF6347", "#FF4500", "#FFD700",
                        "#FF8C00", "#FFA500", "#DAA520", "#B8860B", "#A52A2A", "#800000",
                        "#808080", "#696969", "#708090", "#2F4F4F", "#008080", "#006400",
                        "#556B2F", "#228B22", "#008000", "#32CD32", "#00FF00"
                    ];
        ...
        var lightColor = KTUtil.getCssVariableValue('--kt-info-light');
        colorPalette = [
            '#008FFB', '#00E396', '#FEB019', "#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF",
            "#00FFFF", "#FF4500", "#FF8C00", "#FFD700", "#ADFF2F", "#32CD32", "#00FF7F", "#00FA9A",
            "#008B8B", "#000080", "#4B0082", "#9400D3", "#8A2BE2", "#800080", "#7B68EE", "#483D8B",
            "#000000", "#FFFFFF", "#FFA07A", "#FA8072", "#E9967A", "#F08080", "#CD5C5C", "#DC143C",
            "#B22222", "#FF6347", "#FF4500", "#FFD700", "#FF8C00", "#FFA500", "#DAA520", "#B8860B",
            "#A52A2A", "#800000", "#808080", "#696969", "#708090", "#2F4F4F", "#008080", "#006400",
            "#556B2F", "#228B22", "#008000", "#32CD32", "#00FF00"
        ];
                ...
                success: function(response) {
                    ...
                    if (stats) {
                        ...
                        stats.forEach(entry => {
                            ...
                            10)); // Convert "total" to an integer
    ...
    dashArray: 0, 
        ...
        $('#reportrange').daterangepicker({
            ...
            ranges: {
                ...
                'Last Quarter': [moment().subtract(1, 'quarter').startOf('quarter'), moment().subtract(
                    1, 'quarter').endOf('quarter')],
    ...
    dashArray: 0, 
        ...
        function cb_new(start, end) {
            ...
            $('#reportrange_work_orders_status_wise_THIS_YEAR span').html(start.format('MMMM D, YYYY') + ' - ' +
    ...
    dashArray: 0, 
        ...
        $('#THIS_YEAR_EMP').on('change', function(event) {
            // Retrieve the date range picker instance
            var dateRangePicker = $('#reportrange_work_orders_status_wise_THIS_YEAR').data(
                'daterangepicker');
        ...
        function load_chart_donut(urls = 'graphical_summary_work_order', title, ids, location,
            report_date_range_simple, company = 'All', compare = 'no') {
    ...
    dashArray: 0, 
        ...
        load_chart('graphical_summary_work_order',
            '<?php echo lang('All_time_work_order_current_location') ; ?>', 1,
            <?php echo $current_logged_in_location_id ; ?>, 'ALL_TIME', 'All', 'no');

        load_chart('graphical_summary_sales_time_work_order',
            '<?php echo lang('Today_work_order_current_location') ; ?>', 2,
            <?php echo $current_logged_in_location_id ; ?>, 'TODAY', 'All', 'no');
        <?php if(getenv('MASTER_LOCATION')==$this->Employee->get_logged_in_employee_current_location_id()): ?>
        load_chart('graphical_summary_work_order', '<?php echo lang('All_time_work_order_all_companies') ; ?>',
            3, <?php echo $current_logged_in_location_id ; ?>, 'ALL_TIME', 'All', 'yes');

        load_chart('graphical_summary_sales_time_work_order',
            '<?php echo lang('Today_work_order_all_companies') ; ?>', 4,
            <?php echo $current_logged_in_location_id ; ?>, 'TODAY', 'All', 'yes');

        load_chart_donut('summary_sales_locations_work_order',
            '<?php echo lang('All_time_work_order_all_companies') ; ?>', [5, 7, 9],
            <?php echo $current_logged_in_location_id ; ?>, 'ALL_TIME', 'All', 'yes');

        load_chart_donut('summary_sales_locations_work_order',
            '<?php echo lang('Today_work_order_all_companies') ; ?>', [6, 8, 10],
            <?php echo $current_logged_in_location_id ; ?>, 'TODAY', 'All', 'yes');
        <?php endif; ?>
