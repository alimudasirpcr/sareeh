			...
			<div class="panel panel-piluku">
				...
				<div id="receipt" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
					<div class="panel-body">
						...
						<div class="form-group" data-keyword="<?php echo H(lang('config_remove_tax_percent_on_receipt')) ?>">	
							<?php echo form_label(lang('config_remove_tax_percent_on_receipt').':', 'remove_tax_percent_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_checkbox(array(
								...
								<label for="remove_tax_percent_on_receipt"><span></span></label>
							</div>
						</div>
				...
				<div id="application_settings" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
					<div class="panel-body">
							...
							<div class="form-group" data-keyword="<?php echo H(lang('config_enable_quick_items')) ?>">	
								<?php echo form_label(lang('config_enable_quick_items').':', 'enable_quick_suppliers',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
								<?php echo form_checkbox(array(
       ...
       <div class="col-md-12 shopify_settings ecom_settings <?php echo $shopify_hidden_class; ?>">
		...
		<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_woocommerce')) ?>">	
			...
			<?php if (!is_on_saas_host()) { ?>
				...
				{
				?>
				<h3 style="text-align: center;"><?php echo 'E-mail <a href="mailto:support@phpsalesmanager.com">support@phpsalesmanager.com</a> to obtain these values'?></h3>
	      	<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_woocommerce')) ?>">	
	     ...
	     <div class="col-md-12">
				<div class="panel panel-piluku">
					<div class="panel-heading">
						...
						<a href="https://<?php echo $this->config->item('branding')['domain']; ?>/api.php" onclick="window.open('https://<?php echo $this->config->item('branding')['domain']; ?>/api.php', '_blank', 'width=800,height=600,scrollbars=yes,menubar=no,status=yes,resizable=yes,screenx=0,screeny=0'); return false;"> <span class="glyphicon glyphicon-info-sign"></span></a>
					</div>	
				...
				<div class="panel panel-piluku">
					...
					<div id="work_order" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
						<div class="panel-body">
							...
							<div class="form-group" data-keyword="<?php echo H(lang('config_work_order_warranty_checked_product_price_zero')) ?>">	
								<?php echo form_label(lang('config_work_order_warranty_checked_product_price_zero').':', 'work_order_warranty_checked_product_price_zero',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_checkbox(array(
									...
									<label for="work_order_warranty_checked_product_price_zero"><span></span></label>
								</div>
							</div>
