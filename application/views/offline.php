        ...
        <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 no-padding-right no-padding-left">
            <div class="register-box register-items-form">
                ...
                <div id="itemForm" class="item-form">
                    ...
                    <form action="#" id="add_item_form" class="form-inline" autocomplete="off" method="post"
                        accept-charset="utf-8">


                        <div class="input-group contacts register-input-group">

                            <input type="text" id="item" name="item" class="add-item-input pull-left keyboardTop"
        ...
        <div class="register-box register-right">
            ...
            <div class="customer-form" id="customer-form">
                ...
                <div id="selected_customer_form" class="hidden">
                    ...
                    <a href="javascript:void(0)" id="remove_customer"
                        class="btn btn-primary"><?php echo H(lang('detach')); ?></a>
                </div>

                <form action="#" id="select_customer_form" autocomplete="off" class="form-inline" method="post"
                    accept-charset="utf-8">
                    <div class="input-group contacts">
                        <input type="text" id="customer" name="customer" class="add-customer-input keyboardLeft"
        ...
        <div class="register-box register-summary paper-cut">
            ...
            <div class="add-payment">
                ...
                <?php foreach ($payment_options as $key => $value) {
									...
									?>
                <a tabindex="-1" href="#" class="btn btn-pay select-payment <?php echo $active_payment; ?>"
                    data-payment="<?php echo H($value); ?>">
                    <?php echo H($value); ?>
                </a>
                <?php } ?>


                <form action="#" id="add_payment_form" class="form-inline" autocomplete="off" method="post"
                    accept-charset="utf-8">
