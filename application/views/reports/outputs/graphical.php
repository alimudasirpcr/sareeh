	...
	<div id="report_summary"  class="repors-summarys col-md-12 ">
		<div class="card ">
			<div class="card-header rounded rounded-3 p-5">
				...
				<?php } else { ?>
					<button type="button" class="btn btn-primary text-white hidden-print save_report_button pull-right" 
        style="margin-top: -12px;" 
        data-message="<?php echo H(lang('reports_enter_report_name'));?>"> 
    <?php echo lang('reports_save_report'); ?>
</button>
