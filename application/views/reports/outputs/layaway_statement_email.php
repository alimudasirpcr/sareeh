									...
									<td class="inner no-padding" style="padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:10px;">
										<table width="100%" class="items-table" style="border-spacing:0;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#555555;font-size:13px;padding-top:10px !important;">
											<tr border="1">
												...
												<td width="<?php echo $column_width; ?>" style="background-color:#F5F5F5;height:32px;"><?php echo lang('reports_total'); ?></td>
												<td width="<?php echo $column_width; ?>" style="background-color:#F5F5F5;height:32px;"><?php echo lang('reports_payment'); ?></td>
												<td width="<?php echo $column_width; ?>" style="background-color:#F5F5F5;height:32px;"><?php echo lang('reports_due'); ?></td>
												<?php if (!$hide_items) { ?>
												...
												?>
													...
													<tr class="text-center item-row">
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php echo date(get_date_format() . ' ' . get_time_format(), strtotime($transaction["sale_time"])); ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php echo $transaction['sale_id'] ? $this->config->item('sale_prefix') . ' ' . $transaction['sale_id'] : '-'; ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php echo $transaction['sale_total'] > 0 ? to_currency($transaction['sale_total']) : to_currency(0); ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php //echo to_currency(0); ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php echo to_currency($transaction['sale_total']); ?>
														</td>
													...
													<?php foreach ($transaction["all_payments"] as $payment) { ?>
													<tr class="text-center item-row">
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php echo date(get_date_format() . ' ' . get_time_format(), strtotime($payment["payment_date"])); ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php //echo $payment['sale_id'] ? $this->config->item('sale_prefix') . ' ' . $payment['sale_id'] : '-'; ?>
														</td>
														<td align="center" style="padding-right:0;padding-top:10px !important;padding-left:10px;border-width:1px;border-style:solid;border-color:#DCE0E6;border-bottom-width:0px;border-right-width:0px;padding-bottom:10px;">
															<?php //echo to_currency(0); ?>
														</td>
											...
											<?php $amount_due += $transaction['amount_due'];
											} ?>
											<tr class="text-center item-row">
