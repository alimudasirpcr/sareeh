...
<div class="alert alert-dismissible bg-light-danger d-flex flex-center flex-column py-10 px-10 px-lg-20 mb-10 mt-5">
    <!--begin::Close-->
    <a href="<?php echo site_url('home/dismiss_reseller_message') ?>"
    ...
    <div class="text-center">
        ...
        <div class="d-flex flex-center flex-wrap">
            ...
            <a href="https://<?php echo $this->config->item('branding')['domain']; ?>/resellers_signup.php"
                class="btn btn-danger m-2"><?php echo lang('home_signup_now'); ?></a>
        </div>
        <!--end::Buttons-->
    </div>
    <!--end::Wrapper-->
...
<div class="alert alert-dismissible bg-light-danger d-flex flex-center flex-column py-10 px-10 px-lg-20 mb-10">
    ...
    <div class="text-center">
        ...
        <div class="d-flex flex-center flex-wrap">
            ...
            <a href="https://feedback.<?php echo $this->config->item('branding')['domain']; ?>"
                class="btn btn-danger m-2"><?php echo lang('home_visit_now'); ?></a>
        </div>
        <!--end::Buttons-->
    </div>
    <!--end::Wrapper-->
