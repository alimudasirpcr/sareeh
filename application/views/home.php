							...
							<div class=" border border-dashed border-gray-300 rounded px-7 py-3 mb-6  text-light bg-light-danger">
								...
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('config'); ?>" class="text-gray-800 text-hover-primary fw-bold">
							...
							<div class=" border border-dashed border-gray-300 rounded px-7 py-3 mb-6 bg-light-success">
								...
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('locations'); ?>" class="text-gray-800 text-hover-primary fw-bold">
							...
							<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6 bg-light-info">
								...
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('items/view/-1'); ?>" class="text-gray-800 text-hover-primary fw-bold">
							...
							<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6 bg-light-success"> <!--begin::Info-->
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('employees'); ?>" class="text-gray-800 text-hover-primary fw-bold">
							...
							<div class=" border border-dashed border-gray-300 rounded px-7 py-3 mb-6 bg-light-primary"> <!--begin::Info-->
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('customers/view/-1'); ?>" class="text-gray-800 text-hover-primary fw-bold">
							...
							<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6 bg-light-danger">
								...
								<div class="d-flex flex-stack mb-3">
									...
									<div class="me-3">
										...
										<!--end::Icon-->
										<!--begin::Title-->
										<a href="<?php echo base_url('sales'); ?>" class="text-gray-800 text-hover-primary fw-bold">
		...
		<div class="card card-flush overflow-hidden h-auto">
			...
			<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
				...
				<div class="row mx-2">
					...
					<div class="col-xl-4">
						<div class="d-flex align-items-center flex-column mt-3 w-100 border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
							...
							<div class="h-8px mx-3 w-100 bg-light-<?= $stat->color ?> rounded">
								<div class="bg-<?= $stat->color ?> rounded h-8px" role="progressbar" style="width: <?= $stat->percentage ?>%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
					</div>
					<?php endforeach;?>
