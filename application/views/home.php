											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-body">
													...
													<div class="row pe-6 me-n6" >
														<!--begin::Item-->
														<div class="col-3 border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															<!--begin::Info-->
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	...
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="../dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold"><h4><?php echo lang('module_config');?></h4></a>
																	<!--end::Title-->
																</div>
																<!--end::Wrapper-->
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																	<a href="../dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold"><?php echo lang('home_wizard_configure_company');?></a>
																<!--end::Name-->
																<!--begin::Label-->
			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="reseller_activate_container">
						<h3><a href="https://<?php echo $this->config->item('branding')['domain']; ?>/resellers_signup.php" target="_blank"><?php echo lang('home_resellers_program'); ?></a></h3>
						<p><?php echo lang('home_reseller_program_signup')?></p>
						<a href="https://<?php echo $this->config->item('branding')['domain']; ?>/resellers_signup.php" class="reseller_description btn btn-primary" target="_blank">
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					...
					<div id="reseller_activate_container">
						<h3><a href="https://feedback.<?php echo $this->config->item('branding')['domain']; ?>" target="_blank"><?php echo lang('home_feedback'); ?></a></h3>
						<p><?php echo lang('home_feedback_program')?></p>
						<a href="https://feedback.<?php echo $this->config->item('branding')['domain']; ?>" class="reseller_description btn btn-primary" target="_blank">
			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="mercury_activate_container">
						<h3><a href="http://<?php echo $this->config->item('branding')['domain']; ?>/credit_card_processing.php" target="_blank"><?php echo lang('common_credit_card_processing'); ?></a></h3>
