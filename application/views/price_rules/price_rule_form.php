        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-9 col-lg-10">
                <ul class="list-inline mx-7">
                    <?php
                    echo '<li class="form-check">' . form_checkbox(array('class' => ' form-check-input', 'id' => 'days_of_week_all', 'name' => 'days_of_week_all', 'value' => '1', 'checked' => ($rule_info && $rule_info['days_of_week'] === NULL) || !$rule_info  ? TRUE : FALSE)) . '<label for="days_of_week_all" class="form-check-label"><span></span>' . lang('all') . '</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'mon', 'name' => 'days_of_week[]', 'value' => '1', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '1') !== false ? TRUE : FALSE)) . '<label for="mon" class="form-check-label"><span></span>Mon</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'tue', 'name' => 'days_of_week[]', 'value' => '2', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '2') !== false ? TRUE : FALSE)) . '<label for="tue" class="form-check-label"><span></span>Tue</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'wed', 'name' => 'days_of_week[]', 'value' => '3', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '3') !== false ? TRUE : FALSE)) . '<label for="wed" class="form-check-label"><span></span>Wed</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'thu', 'name' => 'days_of_week[]', 'value' => '4', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '4') !== false ? TRUE : FALSE)) . '<label for="thu" class="form-check-label"><span></span>Thu</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'fri', 'name' => 'days_of_week[]', 'value' => '5', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '5') !== false ? TRUE : FALSE)) . '<label for="fri" class="form-check-label"><span></span>Fri</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'sat', 'name' => 'days_of_week[]', 'value' => '6', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '6') !== false ? TRUE : FALSE)) . '<label for="sat" class="form-check-label"><span></span>Sat</label></li>';
                    echo '<li class="form-check">' . form_checkbox(array('class' => 'dow form-check-input', 'id' => 'sun', 'name' => 'days_of_week[]', 'value' => '0', 'checked' => $rule_info && strpos($rule_info['days_of_week'], '0') !== false ? TRUE : FALSE)) . '<label for="sun" class="form-check-label"><span></span>Sun</label></li>';
                    ?>
                </ul>
            </div>
            <script>
