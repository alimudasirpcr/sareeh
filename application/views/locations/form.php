...
<?php } else { ?>
	...
	<div class="ms-7 flex-row-auto w-lg-200px">
		<!--begin::Sidebar nav-->
		<div class="card card-flush d-none d-lg-flex" data-kt-sticky="true" data-kt-sticky-name="sidebar-navs" data-kt-sticky-offset="{default: false, lg: 200}" data-kt-sticky-width="200px" data-kt-sticky-animation="false" data-kt-sticky-left="auto" data-kt-sticky-top="25px" data-kt-sticky-zindex="5" style="">
			<!--begin::Card body-->
			<div class="card-body px-0 px-3 py-6">
				...
				<ul id="kt_sidebar_nav" class="nav nav-flush menu menu-column menu-title-gray-700 menu-bullet-gray-300 menu-state-primary fw-semibold fs-6">
					...
					<li class="menu-item py-2 px-3">
						<!--begin::Link-->
						<a href="#basic_info_tab" data-kt-scroll-toggle="true" class="menu-link p-0 nav-link active scroll-to-link">
					...
					<li class="menu-item py-2 px-3">
						<!--begin::Link-->
						<a href="#Location-integrations_tab" data-kt-scroll-toggle="true" class="menu-link p-0 nav-link scroll-to-link">
							<span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
							...
							<table id="price_registers" class="table">
								...
								<tbody>
									...
									foreach ($registers->result() as $register) { ?>
										<tr>
											<td><span class="dot terminal"></span><input type="text" class="form-control form-control-solid next-to-status" name="registers_to_edit[<?php echo $register->register_id; ?>][name]" style="margin-top: -17px;" value="<?php echo H($register->name); ?>" /></td>
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 col-md-2 col-lg-2">
							<a href="javascript:void(0)" class="btn btn-primary btn-lg" id="get_authorization_key_btn" style="width:100%;"><?php echo lang('locations_get_authorization_key'); ?></a>
						</div>
					</div>
