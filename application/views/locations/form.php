        ...
        <div class="panel">
            <div class="card-body">
                <h3 style="margin-left: 80px;"><a
                        href="http://<?php echo $this->config->item('branding')['domain']; ?>/buy_additional.php"
                        target="_blank"><?php echo lang('locations_purchase_additional_licenses'); ?> &raquo;</a></h3>
...
<?php echo form_open_multipart('locations/save/' . $location_info->location_id, array('id' => 'location_form', 'class' => 'form-horizontal d-flex flex-column flex-lg-row', 'autocomplete' => 'off')); ?>

<div class="ms-7 flex-row-auto w-lg-200px">
    <!--begin::Sidebar nav-->
    <div class="card card-flush d-none d-lg-flex" data-kt-sticky="true" data-kt-sticky-name="sidebar-navs"
        data-kt-sticky-offset="{default: false, lg: 200}" data-kt-sticky-width="200px" data-kt-sticky-animation="false"
        data-kt-sticky-left="auto" data-kt-sticky-top="25px" data-kt-sticky-zindex="5" style="">
        <!--begin::Card body-->
...
<div class="  flex-row-fluid mb-2" id="form">

    <div class="">
        <div class="card">
            <div class=" card-header rounded rounded-3 p-5">
                <h3 class="panel-title" id="basic_info_tab">
                    <i class="ion-edit"></i>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <select class="form-select form-select-solid" data-control="select2" name="employees[]"
                ...
                <div class="form-group">
                    <label class='col-sm-3 col-md-3 col-lg-2 control-label'
                        ...
                        <br>
                        <small>**<?php echo lang('bold'); ?>**, ~~<?php echo lang('italic'); ?>~~,
                            ||<?php echo lang('underline'); ?>||</small>
                        <br>
                        <small style="border-bottom: 1px dotted #000000;text-decoration: none;cursor:pointer;"
            ...
            <div class="card-body">
                ...
                <div class="form-group add-register-table">
                    ...
                    <div class="table-responsive m-lr-15 col-md-12">
                        <table id="price_registers" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="card_connect_hsn register-cc-field card_connect_info">
                                        <?php echo lang('locations_card_connect_hsn'); ?></th>
                                    <th class="emv_terminal_id register-cc-field">
                                        <?php echo lang('locations_terminal_id'); ?></th>
                                    <th class="enable_tips register-cc-field"><?php echo lang('config_enable_tips'); ?>
                                    </th>
                                    <th class="register-cc-field register-cc-field-datacap">
                                        <?php echo lang('locations_ip_tran_device_id'); ?></th>
                                    <th class="register-cc-field register-cc-field-datacap">
                                        <?php echo lang('locations_pinpad_ip'); ?></th>
                                    <th class="register-cc-field register-cc-field-datacap">
                                        <?php echo lang('locations_pinpad_port'); ?></th>
                                    <th class="register-cc-field register-cc-field-datacap">
                                        <?php echo lang('locations_card_reader_actions'); ?></th>
                                    <th>Receipt Type</th>
                                    <th>Categories</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="dot terminal"></span><input type="text"
                                            class="form-control form-control-solid next-to-status"
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][name]"
                                            style="margin-top: -17px;" value="<?php echo H($register->name); ?>" /></td>

                                    <td class="card_connect_info"><input id="card_connect_hsn_<?php echo $counter; ?>"
                                            type="text"
                                            class="form-control form-control-solidcard_connect_hsn register-cc-field"
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][card_connect_hsn]"
                                            value="<?php echo H($register->card_connect_hsn); ?>" /></td>
                                    <td class="emv_terminal_id register-cc-field text-center">
                                        <?php
												if ($location_info->credit_card_processor == 'square_terminal') {
												?>
                                        <input type="hidden"
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][emv_terminal_id]"
                                            value="<?php echo H($register->emv_terminal_id); ?>" />
                                        <?php
													if (!$register->emv_terminal_id) {
													?>
                                        <br />
                                        <button type="button"
                                            id="square_terminal_get_id_<?php echo $register->register_id; ?>"
                                            class="btn btn-primary"><?php echo lang('config_square_terminal_get_id'); ?></button>
                                        <script>
                                        $("#square_terminal_get_id_<?php echo $register->register_id; ?>").click(
                                            function() {
                                                $.get(<?php echo json_encode(site_url('locations/square_terminal_get_id/' . $location_info->location_id . '/' . $register->register_id)); ?>,
                                                    function(response) {
                                                        bootbox.alert({
                                        ...
                                        <?php
													...
													?>
                                        <br />
                                        <button type="button" id="square_terminal_delete_id"
                                            class="btn btn-danger"><?php echo lang('config_square_terminal_delete_id'); ?></button>
                                        <script>
                                        $("#square_terminal_delete_id").click(function() {
                                            $.get(<?php echo json_encode(site_url('locations/square_terminal_delete_id/' . $location_info->location_id . '/' . $register->register_id)); ?>,
                                                function(response) {
                                                    bootbox.alert({
                                                        title: <?php echo json_encode(lang('config_device_id')); ?>,
                                                        message: response
                                        ...
                                        <?php
													...
													?>
                                        <input id="terminal_id_<?php echo $counter; ?>" type="text"
                                            class="form-control emv_terminal_id register-cc-field"
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][emv_terminal_id]"
                                            value="<?php echo H($register->emv_terminal_id); ?>" />
                                        <?php
												}
                                    ...
                                    <td class="enable_tips register-cc-field-datacap ">
                                        ...
                                        <label
                                            for="registers_to_edit_<?php echo $register->register_id; ?>_enable_tips"><span></span></label>
                                    ...
                                    <td class="register-cc-field-datacap">
                                        ...
                                        <a class="init_ip_tran register-cc-field register-cc-field-datacap"
                                            href="javascript:void(0);"><?php echo lang('locations_init_mercury_emv'); ?></a>
                                        <?php if ((!defined("ENVIRONMENT") or ENVIRONMENT == 'development')) { ?>
                                        <span class="register-cc-field register-cc-field-datacap"> / </span><a
                                            class="test_mode_ip_tran register-cc-field register-cc-field-datacap"
                                            href="javascript:void(0);"><?php echo lang('test_mode'); ?></a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <select class="form-control"
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][receipt_type]">
                                            <?php
													if ($receipt_types) :
														foreach ($receipt_types  as $ty) : ?>
                                            <option <?php if ($register->receipt_type == $ty->id) {
																		echo "selected";
																	} ?> value="<?= $ty->id ?>"><?= $ty->title ?></option>
                                            <?php endforeach;
													endif; ?>
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-select form-select-solid  " data-control="select2" multiple
                                            name="registers_to_edit[<?php echo $register->register_id; ?>][categories][]">
                                            <?php
													$cats = explode(",", $register->categories);
													if ($categories) :
														foreach ($categories  as $cat) : ?>
                                            <option <?php if (in_array($cat->id, $cats)) {
																		echo "selected";
                                    ...
                                    <td>
                                        <a class=" btn btn-danger delete_register" style="margin-top: -67px;"
                                            href="javascript:void(0);"
                                            data-register-id='<?php echo $register->register_id; ?>'><?php echo lang('delete'); ?></a>
                                    </td>
                                </tr>
                                <?php
										$counter++;
                        ...
                        <a class="btn btn-info href=" javascript:void(0);"
                            id="add_register"><?php echo lang('locations_add_register'); ?></a>
                    </div>
                </div>
                <script>
                $(document).ready(refresh_terminal_status_if_needed);
                $(document).on("change",
                    '#blockchyp_api_key,#blockchyp_bearer_token,#blockchyp_signing_key,.emv_terminal_id,.emv_terminal_id input',
                    refresh_terminal_status_if_needed);
                ...
                function refresh_terminal_status() {
                    $('.dot.terminal').each(async function(index, value) {
                        ...
                        const terminal_status = await $.getJSON(SITE_URL +
                            '/locations/get_blockchyp_terminal_status?terminalName=' +
                            encodeURIComponent(terminal_name) + '&blockchyp_api_key=' +
                            encodeURIComponent(blockchyp_api_key) + '&blockchyp_bearer_token=' +
                            encodeURIComponent(blockchyp_bearer_token) + '&blockchyp_signing_key=' +
        ...
        <div class="card mt-5">
            ...
            'value' => '1',
            'class' => 'form-check-input',
            'checked' => isset($location_info->disable_confirmation_option_for_emv_credit_card) ? $location_info->disable_confirmation_option_for_emv_credit_card : false
        )); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_checkbox(array(
									...
									'id' => 'ebt_integrated',
									'value' => '1',
									'checked' => isset($location_info->ebt_integrated) ? $location_info->ebt_integrated : false
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'id' => 'card_connect_mid',
										'autocomplete' => 'off',
										'value' => isset($location_info->card_connect_mid) ? $location_info->card_connect_mid : false 
									)); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->card_connect_rest_username) ? $location_info->card_connect_rest_username : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->card_connect_rest_password) ? $location_info->card_connect_rest_password : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'id' => 'listener_port',
										'autocomplete' => 'off',
										'value' => $location_info->listener_port
									)); ?> (<?php echo lang('locations_3333_is_default_port_for_listener'); ?>)
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'id' => 'net_e_pay_server',
										'autocomplete' => 'off',
										'value' => $location_info->net_e_pay_server
									)); ?> (<?php echo lang('locations_net_e_pay_info'); ?>)
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="init_mercury_emv_wrapper" style="display:none;">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <div id="ajax-loader" style="text-align:center;display:none">
                                    <?php echo img(array('src' => base_url() . 'assets/img/ajax-loader.gif')); ?></div>
                                <button type="button" id="locations_init_mercury_emv"
                                    class="btn btn-primary btn-block"><?php echo lang('locations_init_mercury_emv'); ?></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="mercury_hosted_checkout_info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                ...
                                <span
                                    id="hosted_checkout_merchant_password_note"><?php echo lang('locations_mercury_password_note'); ?></span>
                            </div>
                        </div>
                    </div>
                    <div id="square_terminal_info">
                        <div class="text-center">
                            <?php
        if (isset($location_info->location_id) && $this->Location->get_info_for_key('square_merchant_id', $location_info->location_id)) {
        ?>
                            <a id="disconnect_square"
                                href="<?php echo site_url('locations/oauth_square_auth_disconnect/' . $location_info->location_id); ?>"
                                class="btn btn-danger"><?php echo lang('locations_disconnect_to_square'); ?></a>
                            <script>
                            $("#disconnect_square").click(function(e) {
                                e.preventDefault();
                                bootbox.confirm(
                                    <?php echo json_encode(lang('items_category_delete_confirmation')); ?>,
                                    function(result) {
                                        if (result) {
        ...
        ?>
                            <a href="<?php echo site_url('locations/oauth_square_auth/' . (isset($location_info->location_id) ? $location_info->location_id : '')); ?>"
                                class="btn btn-primary"><?php echo lang('locations_connect_to_square'); ?></a>
                            <?php } ?>
                        </div>
            ...
            echo form_dropdown(
                'square_location_id', 
                isset($square_locations) ? $square_locations : array('' => ''), 
                isset($location_info->square_location_id) ? $location_info->square_location_id : '', 
                'class="form-control" id="auto_reports_email_time"'
            ); 
            ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'value' => isset($location_info->coreclear_merchant_id) ? $location_info->coreclear_merchant_id : false
									)); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->blockchyp_api_key) ? $location_info->blockchyp_api_key : false
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->blockchyp_bearer_token) ? $location_info->blockchyp_bearer_token : false
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->blockchyp_signing_key) ? $location_info->blockchyp_signing_key : false
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' =>isset($location_info->blockchyp_prompt_for_loyalty) ? $location_info->blockchyp_prompt_for_loyalty : false 
									)); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' =>isset($location_info->blockchyp_prompt_for_name) ? $location_info->blockchyp_prompt_for_name : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' =>isset($location_info->blockchyp_prompt_for_email) ? $location_info->blockchyp_prompt_for_email : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' =>isset($location_info->blockchyp_prompt_for_phone_number) ? $location_info->blockchyp_prompt_for_phone_number : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' => isset($location_info->blockchyp_ask_for_missing_info) ? $location_info->blockchyp_ask_for_missing_info : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_textarea(array(
										...
										'rows' => '4',
										'cols' => '30',
										isset($location_info->blockchyp_terms_and_conditions) ? $location_info->blockchyp_terms_and_conditions : false 
									)); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_checkbox(array(
										...
										'value' => '1',
										'checked' => isset($location_info->blockchyp_test_mode) ? $location_info->blockchyp_test_mode : false 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php echo form_input(array(
										...
										'autocomplete' => 'off',
										'value' => isset($location_info->coreclear_mx_merchant_id) ? $location_info->coreclear_mx_merchant_id : false 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <a href="javascript:void(0)" class="btn btn-primary btn-lg" id="get_authorization_key_btn"
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            <div class="tax-container main <?php if (!($location_info->tax_class_id || $location_info->default_tax_1_rate)) {
													echo 'hidden';
												} ?>">
                <div class="form-group">
                ...
                <div style="display:<?php echo $location_info->tax_class_id ? 'none' : 'block'; ?>">
                    ...
                    <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 col-lg-9 col-lg-offset-3"
                        style="display: <?php echo $location_info->default_tax_3_rate ? 'none' : 'block'; ?>">
                    ...
                    <div class="more_taxes_container"
                        style="display: <?php echo $location_info->default_tax_3_rate ? 'block' : 'none'; ?>">
...
$('#get_authorization_key_btn').click(function() {
    ...
    if (merchant_id == '') {
        show_feedback('error', '<?php echo lang('locations_you_must_enter_a_valid_merchant_id'); ?>',
            '<?php echo lang('error'); ?>');
    ...
    if (coreclear_consumer_key == '') {
        show_feedback('error', '<?php echo lang('locations_you_must_enter_a_coreclear_consumer_key'); ?>',
            '<?php echo lang('error'); ?>');
    ...
    if (coreclear_secret_key == '') {
        show_feedback('error', '<?php echo lang('locations_you_must_enter_a_coreclear_secret_key'); ?>',
            '<?php echo lang('error'); ?>');
...
$(document).ready(function() {
    ...
    $("#locations_init_mercury_emv").click(function() {
        ...
        $.post('<?php echo site_url("locations/save_emv_data/" . $location_info->location_id); ?>', {
            ...
            if (response.success) {
                ...
                emv_param_download(emv_param_download_init_params['post_host'], listener_port,
                    emv_param_download_init_params.post_data,
                    <?php echo json_encode(lang('locations_init_device_success')); ?>,
                    <?php echo json_encode(lang('locations_unable_to_init_device')); ?>,
                    function() {
                        $("#ajax-loader").hide();
    ...
    $(".delete_register").click(function() {
        $("#location_form").append('<input type="hidden" name="registers_to_delete[]" value="' + $(this)
            .data('register-id') + '" />');
...
$("#add_register").click(function() {
    ...
    $("#enable_credit_card_processing").change(check_enable_credit_card_processing).ready(
        check_enable_credit_card_processing);
    ...
    function check_credit_card_processor() {
        ...
        } else if (cc_processor == 'heartland' || cc_processor == 'evo' || cc_processor == 'worldpay' ||
            cc_processor == 'firstdata' || cc_processor == 'other_usb') {
            $("#emv_info").show();
...
$(document).ready(function() {
    // Listen for click events on links with the class 'scroll-to-link'
    $('a.scroll-to-link').click(function(e) {
        // Prevent the default action of the link (jumping to the target)
        e.preventDefault();

        // Get the href attribute of the clicked link
        var targetId = $(this).attr('href');

        // Use the targetId to find the target element and get its position on the page
