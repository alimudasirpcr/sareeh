                        ...
                        <div class="app-navbar align-items-center flex-shrink-0 hidden-print">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <?php if ($this->Employee->has_module_permission('sales', $employee_id)) { ?>
                                                ...
                                                <div class="col-6">
                                                    <a href="<?php echo site_url('sales'); ?>" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                            ...
                                            <?php if ($this->Employee->has_module_permission('work_orders', $employee_id)) { ?>
                                                ...
                                                <div class="col-6">
                                                    <a href="<?php echo site_url('work_orders?new=1'); ?>" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                                        <!--begin::Svg Icon | path: icons/duotune/finance/fin009.svg-->
                                                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                            ...
                                            <?php if ($this->Employee->has_module_permission('receivings', $employee_id)) { ?>
                                                ...
                                                <div class="col-6">
                                                    <a href="<?php echo site_url('receivings/po/'); ?>" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                                        <!--begin::Svg Icon | path: icons/duotune/finance/fin009.svg-->
                                                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                            ...
                                            <?php if ($this->Employee->has_module_action_permission('customers', 'add_update', $employee_id)) { ?>
                                                ...
                                                <div class="col-6">
                                                    <a href="<?php echo site_url('customers/view/-1/'); ?>" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                                        <!--begin::Svg Icon | path: icons/duotune/finance/fin009.svg-->
                                                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                            ...
                                            <?php if ($this->Employee->has_module_action_permission('items', 'add_update', $employee_id)) { ?>
                                                ...
                                                <div class="col-6">
                                                    <a href="<?php echo site_url('items/view/-1/'); ?>" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                                        <!--begin::Svg Icon | path: icons/duotune/finance/fin009.svg-->
                                                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                            ...
                            <?php if (is_on_demo_host() || ($this->config->item('show_language_switcher') && $this->Employee->has_module_action_permission('employees', 'edit_profile', $this->Employee->get_logged_in_employee_info()->person_id))) { ?>
                                ...
                                <div class="app-navbar-item ms-2 ms-lg-4">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                        <!--begin::Heading-->
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo base_url() ?>assets/css_good/media/misc/menu-header-bg.jpg')">
                                            <!--begin::Title-->
                                            ...
                                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                                <li class="nav-item">
                                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="#kt_topbar_notifications_5"><?php echo lang('list_languages') ?></a>
                                                </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <!--begin::Tab panel-->
                                            <div class="tab-pane fade show active" id="kt_topbar_notifications_5" role="tabpanel" style="display: block;">
                                                <!--begin::Wrapper-->
                                                <!--begin::Items-->
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-4">
                                ...
                                <?php if ($total_msgs_count > 0) { ?>
                                    <a href="#" class="btn btn-icon <?php echo $total_msgs_count > 0 ? 'btn-danger' : ''; ?>  btn-outline fw-bold count <?php echo $total_msgs_count > 0 ? 'bell' : ''; ?>" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom" id="unread_message_count">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                    ...
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo base_url(); ?>assets/css_good/media/misc/menu-header-bg.jpg')">
                                        ...
                                        <h3 class="text-dark fw-semibold px-9 mt-10 mb-6"> <?= lang('notifications') ?>
                                            <span class="fs-8 opacity-75 ps-3"><?php echo $total_msgs_count; ?> <?php echo lang('notifications') ?></span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Tabs-->
                                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                            <li class="nav-item">
                                                <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4 active first_active" data-bs-toggle="tab" href="#" data-target="#kt_topbar_notifications_2"><?php echo lang('messages') ?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#" data-target="#kt_topbar_notifications_3"><?php echo lang('transfer_requests') ?></a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade " id="kt_topbar_notifications_3" role="tabpanel">
                                            ...
                                            <div class="py-3 text-center border-top">
                                                <a href="<?= site_url('notifications') ?>" class="btn btn-color-gray-600 btn-active-color-primary">
                                                    <?= lang('view_all') ?>
                            ...
                            <?php else : ?>
                                                                                    ...
                                                                                    <?php if (
                                                                                        ...
                                                                                        <?php if (!isset($is_pos)) : ?>
                                                                                            ...
                                                                                            <?php else : ?>
                                                                                                ...
                                                                                                <?php if(!check_allowed_module($allowed_modules->result() ,'meters' ) &&  
                                            !check_allowed_module($allowed_modules->result() ,'meterreadings' )){}else{ ?>

                                <?php if(!isset($is_pos)): ?>
                                    <div data-kt-menu-trigger="click" class="menu-item <?php echo ($this->uri->segment(1) == 'meters' || $this->uri->segment(1) == 'meterreadings')  ? 'here show' : ''; ?>  menu-accordion">
							
                                    <?php  else: ?>
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" class="menu-item <?php echo ($this->uri->segment(1) == 'meters' || $this->uri->segment(1) == 'meterreadings' )  ? 'here show' : ''; ?>  menu-accordion">
                                ...
                                <?php endif; ?>
									...
									<span class="menu-link">
                                        ...
                                        <?php if(!isset($is_pos)): ?>
                                    	<span class="menu-title"><?php echo lang('meters'); ?></span>
                                        <span class="menu-arrow"></span>
                                        <?php endif; ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php if(check_allowed_module($allowed_modules->result() ,'meters' )): ?>
                                        <?php if($this->Employee->has_module_permission('meters', $employee_id)) { ?>
                                            <!--begin:Menu item-->
                                  
                                            <div class="menu-item" >
                                                <a class="menu-link  <?= ($this->uri->segment(1) == 'meters') ?  'active': '' ?> " href="<?php echo site_url('meters'); ?>">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title"><?php echo lang('meters')?></span>
                                    ...
                                    <?php if(check_allowed_module($allowed_modules->result() ,'meterreadings' )): ?>
                                        <?php if($this->Employee->has_module_permission('meterreadings', $employee_id)) { ?>
                                            <!--begin:Menu item-->
                                  
                                            <div class="menu-item" >
                                                <a class="menu-link  <?= ($this->uri->segment(1) == 'meterreadings') ?  'active': '' ?> " href="<?php echo site_url('meterreadings'); ?>">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title"><?php echo lang('meterreadings')?></span>
                                                </a>
                                            </div>
                                ...
                                <?php } ?>
                                                                                                ...
                                                                                                <?php if (
                                                                                                    ...
                                                                                                    <?php if (!isset($is_pos)) : ?>
                                                                                                        <div data-kt-menu-trigger="click" class="menu-item <?php echo ($this->uri->segment(1) == 'reports' || $this->uri->segment(1) == 'notifications' || $this->uri->segment(1) == 'logs')  ? 'here show' : ''; ?>  menu-accordion">

                                                                                                        <?php else : ?>
                                                                                                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" class="menu-item <?php echo ($this->uri->segment(1) == 'reports' || $this->uri->segment(1) == 'notifications' || $this->uri->segment(1) == 'logs')  ? 'here show' : ''; ?>  menu-accordion">
                                                                                                            ...
                                                                                                            <span class="menu-link">
                                                                                                                ...
                                                                                                                <?php if (!isset($is_pos)) : ?>
                                                                                                                    <span class="menu-title"><?php echo lang('analytics_&_logs'); ?></span>
                                                                                                                    <span class="menu-arrow"></span>
                                                                                                                <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                                            ...
                                                            class="fw-semibold text-muted text-hover-primary fs-7">Staff</a> -->
                                                                                                                                ...
                                                                                                                                <?php if ($this->Location->get_info_for_key('blockchyp_api_key') && $this->Employee->has_module_action_permission('sales', 'view_edit_transaction_history', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                                                                                                                                    ...
                                                                                                                                    <!--begin::Menu item-->
                                                                                                                                    <div class="menu-item px-5">
                                                                                                                                        <a htarget="_blank" tabindex="-1" title="" href="<?php echo site_url('sales/coreclear_portal') ?>" class="menu-link px-5">
                                                                                                                        ...
                                                                                                                        <div class="me-2">
                                                                                                                            <!--begin::Username-->
                                                                                                                            <a href="#" class="app-sidebar-username text-gray-800 text-hover-primary fs-6 fw-semibold lh-0"><?php echo H($user_info->first_name . " " . $user_info->last_name); ?></a>
                                                                                                                            <!--end::Username-->
                                                                                                                            <!--begin::Description-->
