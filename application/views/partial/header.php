				...
				?>			
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                        ...
                        <div class="app-navbar align-items-center flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-4">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                    ...
                                    <div class="row g-0">
                                        <!--begin:Item-->
                                        <div class="col-6">
                                            <a href="../dist/apps/projects/budget.html"
                                        ...
                                        <!--begin:Item-->
                                        <div class="col-6">
                                            <a href="../dist/apps/projects/settings.html"
                                        ...
                                        <!--begin:Item-->
                                        <div class="col-6">
                                            <a href="../dist/apps/projects/users.html"
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-4">
                                <!--begin::Menu wrapper-->
                                <a href="#" class="btn btn-icon btn-primary fw-bold" data-kt-menu-trigger="click"
