...
<head>
    ...
    foreach (get_js_files() as $js_file) { ?>
        <script src="<?php echo base_url() . $js_file['path'] . '?' . ASSET_TIMESTAMP; ?>" type="text/javascript"
            charset="UTF-8">
        </script>
    <?php } ?>
    ...
    <?php } ?><script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js">
    </script>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url(); ?>assets\css_phpsalesmanager\bootstrap-colorpicker.min.css">
    </link>
    <script type="text/javascript">
        <?php
...
<body data-kt-name="good" id="kt_app_body"
    data-kt-app-layout="<?= (isset($is_pos)) ? 'mini-sidebar' : 'light-sidebar' ?>"
    data-kt-app-sidebar-enabled="<?= isset($is_pos) ? 'false' : 'true'; ?>"
    data-kt-app-sidebar-fixed="<?= isset($is_pos) ? 'false' : 'true'; ?>" data-kt-app-sidebar-push-header="true"
    data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default"
    data-kt-app-sidebar-minimize="<?= (isset($minimize_sidebar)) ? $minimize_sidebar : 'off'; ?>">
    ...
    <div id="kt_drawer_gen_lg" class="bg-white hidden-print" data-kt-drawer-dismiss="true" data-kt-drawer="true"
        ...
        <div class="card border-0 shadow-none rounded-0 w-100">
            ...
            <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
                ...
                <!--begin::Card title-->
                <h3 class="card-title fs-3 fw-bold text-black flex-column m-0" id="kt_drawer_general_title_lg">
                </h3>
                <!--end::Card title-->

                <!--begin::Card toolbar-->
                <div class="card-toolbar">
                    <button type="button" class="btn btn-sm btn-icon fs-2 text-black p-0 w-20px h-20px rounded-1"
                        id="kt_app_layout_builder_close">
                        x </button>
                </div>
                <!--end::Card toolbar-->
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <?php if (!isset($remove_topbar)): ?>
            <div class="app-page flex-column " id="kt_app_page">
                            ...
                            <div class="app-navbar align-items-center flex-shrink-0 hidden-print">
                                ...
                                ?>
                                    ...
                                    <div class="app-navbar-item ms-2 ms-lg-4">
                                        <!--begin::Menu- wrapper-->
                                        <a href="#"
                                            class="btn btn-custom btn-icon btn-outline btn-icon-gray-700 bg-light btn-active-icon-primary"
                                                ...
                                                <?php if ($this->Employee->has_module_permission('sales', $employee_id)) { ?>
                                                    ...
                                                    <div class="col-6">
                                                        <a href="<?php echo site_url('sales'); ?>"
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <span
                                                                class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('sales_new_sale'); ?></span>
                                                        </a>
                                                    </div>
                                                    <!--end:Item-->
                                                <?php } ?>
                                                ...
                                                <?php if ($this->Employee->has_module_permission('work_orders', $employee_id)) { ?>
                                                    ...
                                                    <div class="col-6">
                                                        <a href="<?php echo site_url('work_orders?new=1'); ?>"
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <span
                                                                class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('new_work_order'); ?></span>
                                                        </a>
                                                    </div>
                                                    <!--end:Item-->
                                                <?php } ?>
                                                ...
                                                <?php if ($this->Employee->has_module_permission('receivings', $employee_id)) { ?>
                                                    ...
                                                    <div class="col-6">
                                                        <a href="<?php echo site_url('receivings/po/'); ?>"
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <span
                                                                class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('new_purchase_order'); ?></span>
                                                        </a>
                                                    </div>
                                                    <!--end:Item-->
                                                <?php } ?>
                                                ...
                                                <?php if ($this->Employee->has_module_action_permission('customers', 'add_update', $employee_id)) { ?>
                                                    ...
                                                    <div class="col-6">
                                                        <a href="<?php echo site_url('customers/view/-1/'); ?>"
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <span
                                                                class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('customers_new'); ?></span>
                                                        </a>
                                                    </div>
                                                    <!--end:Item-->
                                                <?php } ?>
                                                <?php if ($this->Employee->has_module_action_permission('items', 'add_update', $employee_id)) { ?>
                                                    ...
                                                    <div class="col-6">
                                                        <a href="<?php echo site_url('items/view/-1/'); ?>"
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <span
                                                                class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('items_new'); ?></span>
                                                        </a>
                                                    </div>
                                                    <!--end:Item-->
                                                <?php } ?>
                                ...
                                <?php if (is_on_demo_host() || ($this->config->item('show_language_switcher') && $this->Employee->has_module_action_permission('employees', 'edit_profile', $this->Employee->get_logged_in_employee_info()->person_id))) { ?>
                                    ...
                                    <div class="app-navbar-item ms-2 ms-lg-4">
                                        ...
                                        <a href="#" class="btn btn-custom btn-outline btn-icon btn-icon-gray-700 btn-active-icon-primary w-100"
                                            ...
                                            <span class="fs-8"><img class="flag_img"
                                                    src="<?php echo base_url(); ?>assets/assets/images/flags/<?php echo $user_info->language ? $user_info->language : "english";  ?>.png"
                                                    alt="" style=" width: 18px; margin-bottom: 3px;"> <span
                                                    class="hidden-sm hidden-xs">
                                                    <?php echo $user_info->language ? $languages[$user_info->language] : $languages["english"];  ?></span></span>
                                        </a>
                                        <!--begin::Menu-->
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <div class="d-flex flex-stack py-4">
                                                                        ...
                                                                        <div class="d-flex align-items-center me-2">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <a href="<?php echo site_url('employees/set_language/') ?>"
                                                                                data-language-id="<?php echo $key; ?>"
                                                                                class="text-gray-800 text-hover-primary fw-semibold set_employee_language">
                                                                                <img class="flag_img"
                                                                                    src="<?php echo base_url(); ?>assets/assets/images/flags/<?php echo $key; ?>.png"
                                                                                    alt="flags"
                                                                                    style=" width: 30px;margin: 5px;"><?php echo $value; ?>
                                                                            </a>
                                                                            <!--end::Title-->
                                                                        </div>
                                                                        <!--end::Section-->
                                ...
                                <div class="app-navbar-item ms-2 ms-lg-4">
                                    ...
                                    <?php $new_message_count =  count($this->Employee->get_messages()); ?>
                                    <?php $total_msgs_count =   $noti_count + $new_message_count; ?>

                                    <?php if ($total_msgs_count > 0) { ?>
                                        <a href="#"
                                            class="btn btn-icon <?php echo $total_msgs_count > 0 ? 'btn-danger' : ''; ?>  btn-outline fw-bold count <?php echo $total_msgs_count > 0 ? 'bell' : ''; ?>"
                                            data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                            data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                        ...
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                            style="background-image:url('<?php echo base_url(); ?>assets/css_good/media/misc/menu-header-bg.jpg')">
                                            <!--begin::Title-->
                                            <h3 class="text-dark fw-semibold px-9 mt-10 mb-6"> <?= lang('notifications') ?>
                                                <span class="fs-8 opacity-75 ps-3"><?php echo $total_msgs_count; ?>
                                                    <?php echo lang('notifications') ?></span>
                                            </h3>
                                            <!--end::Title-->
                                            <!--begin::Tabs-->
                                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                                <li class="nav-item">
                                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4 active first_active"
                                                        data-bs-toggle="tab" href="#"
                                                        data-target="#kt_topbar_notifications_2"><?php echo lang('messages') ?></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4"
                                                        data-bs-toggle="tab" href="#"
                                                        data-target="#kt_topbar_notifications_3"><?php echo lang('transfer_requests') ?></a>
                                                </li>
                                                        ...
                                                        <?php foreach ($this->Employee->get_notifications(4) as $key => $value) { ?>
                                                            ...
                                                            <div class="d-flex flex-stack py-4">
                                                                ...
                                                                <div class="d-flex align-items-center me-2">
                                                                    <!--begin::Code-->
                                                                    <span
                                                                        class="w-70px badge badge-light-success me-4"><?php echo lang('new') ?></span>
                                                                    <!--end::Code-->
                                                                    <!--begin::Title-->
                                                                    <?php $href = '';
                                                                    ...
                                                                    <a href="<?php echo $href; ?>"
                                                                        class="text-gray-800 text-hover-primary fw-semibold"><?php echo H($value['message']); ?></a>
                                                                    <!--end::Title-->
                                                                </div>
                                                                <!--end::Section-->
                                                                <!--begin::Label-->
                                                                <span
                                                                    class="badge badge-light fs-8"><?php echo time_elapsed_string($value['created_at']) ?>
                                                                </span>
                                                                <!--end::Label-->
                                                            </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">Staff</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a htarget="_blank" tabindex="-1" title=""
                                href="<?php echo site_url('sales/coreclear_portal')?>" class="menu-link px-5">
                                <span class="menu-text"><?php echo lang('sales_coreclear_portal'); ?></span>
                        ...
                        <div class="menu-item px-5">
                            <atabindex="-1" id="switch_user"
                                ...
                                data-toggle="modal" data-target="#myModalDisableClose" class="menu-link px-5">
                ...
                <div class="me-2">
                    ...
                    <!--end::Username-->
                    <!--begin::Description-->
                    <span class="app-sidebar-deckription text-gray-400 fw-semibold d-block fs-8">Staff</span>
                    <!--end::Description-->
                </div>
                <!--end::Info-->
            </div>
        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
            <?php if (isset($receipt_builder)): ?>
                <div class="app-sidebar bg-black app-sidebar-menu-arrow hover-scroll-overlay-y  px-3 pos-menu"
                    ...
                    <div class="menu menu-column menu-sub-indention menu-active-bg fw-semibold     " id="kt_sidebar_menu"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" class="menu-item   " id="menu-container">
                            ...
                            <span class=" menu-link " data-id="shapes">
                                <span id="kt_drawer_goto" class="menu-icon w-100 " data-bs-custom-class="tooltip-inverse"
                                    ...
                                    <span class="svg-icon svg-icon-muted svg-icon-2x  w-100 text-center ">
                                        ...
                                        <span class="menu-title d-block w-100 text-center "><?= lang('shapes'); ?></span>
                                    </span>
                                </span>
                            </span>
                            ...
                            <span class=" menu-link " data-id="lables">
                                <span id="kt_drawer_goto" class="menu-icon w-100 " data-bs-custom-class="tooltip-inverse"
                                    ...
                                    <span class="svg-icon svg-icon-muted svg-icon-2x  w-100 text-center ">
                                        ...
                                        <span class="menu-title d-block w-100 text-center "><?= lang('lables'); ?></span>
                                    </span>
                                </span>
                            </span>
                            ...
                            <span class=" menu-link " data-id="upload_images">
                                <span id="kt_drawer_goto" class="menu-icon w-100 " data-bs-custom-class="tooltip-inverse"
                                    ...
                                    <span class="svg-icon svg-icon-muted svg-icon-2x  w-100 text-center ">
                                        ...
                                        <span class="menu-title d-block w-100 text-center "><?= lang('uploads'); ?></span>
                                    </span>
                                </span>
                            </span>

                            <span class=" menu-link active " data-id="setup">
                                <span id="kt_drawer_goto" class="menu-icon w-100 " data-bs-custom-class="tooltip-inverse"
                                    data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click"
                                    data-bs-trigger="hover" data-bs-original-title="Metronic Builder" data-kt-initialized="1">
                                    <span class="svg-icon svg-icon-muted svg-icon-2x  w-100 text-center ">
                                        ...
                                        <span class="menu-title d-block w-100 text-center "><?= lang('setup'); ?></span>
                                    </span>
                                </span>
                            </span>
                            ...
                            <span class=" menu-link " data-id="print_view">
                                <span id="kt_drawer_goto" class="menu-icon w-100 " data-bs-custom-class="tooltip-inverse"
                                    ...
                                    <span class="svg-icon svg-icon-muted svg-icon-2x  w-100 text-center ">
                                        ...
                                        <span class="menu-title d-block w-100 text-center "><?= lang('preview'); ?></span>
                                    </span>
                                </span>
                            </span>
                    ...
                    ?>
                        ...
                        <div class="app-sidebar-toolbar d-flex flex-stack py-6 px-8">
                                    ...
                                    <?php if (count($authenticated_locations) > 0) : ?>
                                        <?php foreach ($authenticated_locations as $key => $value) { ?>
                                            <option <?php if ($current_logged_in_location_id == $key) {
                                                ...
                                                data-a="<?php echo site_url('home/set_employee_current_location_id/' . $key) ?>">
                            ...
                            <?php if ($this->Employee->has_module_action_permission('locations', 'add_update', $this->Employee->get_logged_in_employee_info()->person_id) && !$deleted) { ?>
                                ...
                                <a id="new_location_btn" href="<?php echo base_url('locations/view/-1/') ?>"
                                    class="btn btn-icon btn-custom fw-bold flex-shrink-0 ms-3 rounded-circle" data-bs-toggle="modal"
                                    ...
                                    $('#new_location_btn').click(function() {
                                        bootbox.confirm({
                                            ...
                                            callback: function(result) {
                                                if (result) {
                                                    window.location =
                                                        'http://<?php echo $this->config->item('branding')['domain']; ?>/buy_additional.php';
                                                } else {
                        ...
                        <div class="menu menu-column menu-sub-indention menu-active-bg fw-semibold     " id="#kt_sidebar_menu"
                            ...
                            <?php if (!isset($is_pos)) : ?>
                                <div data-kt-menu-trigger="click"
                                    class="menu-item <?php echo $this->uri->segment(1) == 'home' && $this->uri->segment(2) != 'payvantage'  ? 'here show' : ''; ?>  menu-accordion">
                                <?php else : ?>
                                    ...
                                    <span class="menu-link">
                                        ...
                                        <?php if (!isset($is_pos)) : ?>
                                            <span class="menu-title"><?php echo lang('overview'); ?></span>
                                    ...
                                    <?php if (!isset($is_pos)) : ?>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link <?php echo $this->uri->segment(1) == 'home' && $this->uri->segment(2) != 'work_order_dashboard' && $this->uri->segment(2) != 'payvantage'  ? 'active' : ''; ?>"
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link <?php echo $this->uri->segment(1) == 'home' && $this->uri->segment(2) == 'work_order_dashboard'  && $this->uri->segment(2) != 'payvantage'  ? 'active' : ''; ?>"
                                                    href="<?php echo site_url('home'); ?>/work_order_dashboard">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            if ($this->config->item('payvantage')) { ?>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link <?php echo $this->uri->segment(2) == 'payvantage'  ? 'active' : ''; ?>"
                                                        href="<?php echo site_url('home/payvantage'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div class="menu-item pt-5">
                                            <div class="menu-content">
                                                ...
                                                <span class="fw-bold menu-heading fs-7"
                                                    ...
                                                    onclick="show_quick_access()">&nbsp; &nbsp;<?php echo lang('edit') ?></span>
                                            </div>
                                        </div>
                                        ...
                                        ?>
                                            ...
                                            <?php if ($this->Employee->has_module_permission('sales', $employee_id) && in_array('pos', $quick_access)) { ?>
                                                <div class="menu-item"
                                                    <?php echo array_search('sales', $disable_modules) === false ? '' : 'style="display: none;"' ?>>
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'sales' && $this->uri->segment(2) != 'sales_list') ?  'active' : '' ?>"
                                            ...
                                            <?php if ($this->Employee->has_module_permission('receivings', $employee_id) && in_array('transfer', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'receivings' && $this->uri->segment(2) == 'transfer') ?  'active' : '' ?>"
                                                        href="<?php echo site_url('receivings/transfer'); ?>">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/abstract/abs027.svg-->
                                                            <span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="24" height="24"
                                                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <?php if ($this->Employee->has_module_permission('work_orders', $employee_id) && in_array('work_orders', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'work_orders') ?  'active' : '' ?>"
                                                        href="<?php echo site_url('work_orders'); ?>">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/abstract/abs027.svg-->
                                                        ...
                                                        <?php if (!isset($is_pos)) : ?>
                                                            <span class="menu-title"><?php echo lang("work_orders"); ?></span>
                                                        <?php endif; ?>
                                                    </a>
                                                </div>
                                            ...
                                            <?php if ($this->Employee->has_module_permission('deliveries', $employee_id) && in_array('deliveries', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'deliveries') ?  'active' : '' ?>"
                                                        href="<?php echo site_url('deliveries'); ?>">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/abstract/abs027.svg-->
                                                            <span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <?php if (!isset($is_pos)) : ?>
                                                            <span class="menu-title"><?php echo lang("deliveries"); ?></span>
                                                        <?php endif; ?>
                                                    </a>
                                                </div>

                                            <?php } ?>
                                            <?php if ($this->Employee->has_module_permission('suppliers', $employee_id) && in_array('suppliers', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'suppliers') ?  'active' : '' ?>"
                                                        ...
                                                        <?php if (!isset($is_pos)) : ?>
                                                            <span class="menu-title"><?php echo lang("suppliers"); ?></span>
                                                        <?php endif; ?>
                                                    </a>
                                                </div>
                                            ...
                                            <?php if ($this->Employee->has_module_action_permission('receivings', 'list', $employee_id) && in_array('receivings_list', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(2) == 'receivings_list') ?  'active' : '' ?>"
                                                        href="<?php echo site_url('receivings/receivings_list'); ?>">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/abstract/abs027.svg-->
                                                            <span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <?php if ($this->Employee->has_module_permission('sales', $employee_id) && in_array('sales_list', $quick_access)) { ?>
                                                <div class="menu-item">
                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'sales' &&  $this->uri->segment(2) == 'sales_list') ?  'active' : '' ?>"
                                                        href="<?php echo site_url('sales/sales_list'); ?>">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/abstract/abs027.svg-->
                                                            <span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <?php if (!$this->Employee->has_module_permission('sales', $employee_id)  &&   !check_allowed_module($allowed_modules->result(), 'invoices') &&  !check_allowed_module($allowed_modules->result(), 'customers')) {
                                            /** below menud will not be shown as no permisson **/
                                        } else { ?>
                                            ...
                                            <?php if (!isset($is_pos)) : ?>
                                                ...
                                                <?php else : ?>
                                                    ...
                                                    <?php if (!isset($is_pos)) : ?>
                                                        ...
                                                        <?php else : ?>
                                                            ...
                                                            <?php if (check_allowed_module($allowed_modules->result(), 'invoices')) : ?>
                                                                ...
                                                                <?php if (module_access_check_view('invoices')) { ?>
                                                                    <div class="menu-item">
                                                                        <a class="menu-link  <?= ($this->uri->segment(3) == 'customer') ?  'active' : '' ?> "
                                                                            href="<?php echo site_url('invoices/index/customer'); ?>">
                                                                            <span class="menu-bullet">
                                                                                <span class="bullet bullet-dot"></span>
                                                                            </span>
                                                            ...
                                                            <?php if ($this->Employee->has_module_action_permission('sales', 'list', $this->Employee->get_logged_in_employee_info()->person_id)) : ?>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link  <?= ($this->uri->segment(2) == 'sales_list') ?  'active' : '' ?> "
                                                                        href="<?php echo site_url('sales/sales_list'); ?>">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                    ...
                                                    <?php if (!check_allowed_module($allowed_modules->result(), 'work_orders') && !check_allowed_module($allowed_modules->result(), 'deliveries') && !check_allowed_module($allowed_modules->result(), 'appointments')) {
                                                    } else { ?>
                                                        ...
                                                        <?php if (!isset($is_pos)) : ?>
                                                            ...
                                                            <?php else : ?>
                                                                ...
                                                                <?php if (!isset($is_pos)) : ?>
                                                                    ...
                                                                    <?php else : ?>
                                                                        <div
                                                                            class="menu-sub menu-sub-dropdown px-lg-2 py-lg-4 w-200px w-lg-225pxn">
                                                                        <?php endif; ?>
                                                                            ...
                                                                            <?php if ($this->Employee->has_module_permission('work_orders', $employee_id)) { ?>
                                                                                ...
                                                                                <div class="menu-item">
                                                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'work_orders') ?  'active' : '' ?> "
                                                                                        ...
                                                                                        <span
                                                                                            class="menu-title"><?php echo lang('workorder') ?></span>
                                                                                    </a>
                                                                                </div>
                                                                            ...
                                                                            <?php if ($this->Employee->has_module_permission('deliveries', $employee_id)) { ?>
                                                                                ...
                                                                                <div class="menu-item">
                                                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'deliveries') ?  'active' : '' ?> "
                                                                                        ...
                                                                                        <span
                                                                                            class="menu-title"><?php echo lang('module_deliveries') ?></span>
                                                                                    </a>
                                                                                </div>
                                                                        ...
                                                                        <?php if (check_allowed_module($allowed_modules->result(), 'appointments')) : ?>
                                                                            <?php if ($this->Employee->has_module_permission('appointments', $employee_id)) { ?>
                                                                                ...
                                                                                <div class="menu-item">
                                                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'appointments') ?  'active' : '' ?> "
                                                                                        href="<?php echo site_url('appointments'); ?>">
                                                                                        <span class="menu-bullet">
                                                                                            <span class="bullet bullet-dot"></span>
                                                                                        </span>
                                                                                        <span
                                                                                            class="menu-title"><?php echo lang('module_appointments') ?></span>
                                                                                    </a>
                                                                                </div>
                                                                ...
                                                                <?php if (!check_allowed_module($allowed_modules->result(), 'receivings') && !check_allowed_module($allowed_modules->result(), 'invoices') && !check_allowed_module($allowed_modules->result(), 'suppliers')) {
                                                                } else { ?>
                                                                    ...
                                                                    <?php if (!isset($is_pos)) : ?>
                                                                        ...
                                                                        <?php else : ?>
                                                                            ...
                                                                            <?php if (!isset($is_pos)) : ?>
                                                                                ...
                                                                                <?php else : ?>
                                                                                    <div
                                                                                        class="menu-sub menu-sub-dropdown px-lg-2 py-lg-4 w-200px w-lg-225px">
                                                                                    <?php endif; ?>
                                                                                    ...
                                                                                    <?php if (check_allowed_module($allowed_modules->result(), 'receivings')) : ?>
                                                                                        <?php if ($this->Employee->has_module_permission('receivings', $employee_id)) { ?>
                                                                                            ...
                                                                                            <div class="menu-item">
                                                                                                <a class="menu-link  <?= ($this->uri->segment(1) == 'receivings' && $this->uri->segment(2) != 'transfer' && $this->uri->segment(2) != 'receivings_list') ?  'active' : '' ?> "
                                                                                                    href="<?php echo site_url('receivings'); ?>">
                                                                                                    <span class="menu-bullet">
                                                                                                        <span class="bullet bullet-dot"></span>
                                                                                                    </span>
                                                                                                    <span
                                                                                                        class="menu-title"><?php echo lang('receiving') ?></span>
                                                                                                </a>
                                                                                            </div>
                                                                                    ...
                                                                                    <?php if ($this->Employee->has_module_action_permission('receivings', 'list', $this->Employee->get_logged_in_employee_info()->person_id)) : ?>
                                                                                        ...
                                                                                        <div class="menu-item">
                                                                                            <a class="menu-link  <?= ($this->uri->segment(2) == 'receivings_list') ?  'active' : '' ?> "
                                                                                                ...
                                                                                                <span
                                                                                                    class="menu-title"><?php echo lang('receivings_list') ?></span>
                                                                                            </a>
                                                                                        </div>
                                                                                    ...
                                                                                    <?php if (check_allowed_module($allowed_modules->result(), 'invoices')) : ?>
                                                                                        <?php if ($this->Employee->has_module_permission('invoices', $employee_id)) { ?>
                                                                                            ...
                                                                                            <div class="menu-item">
                                                                                                <a class="menu-link  <?= ($this->uri->segment(3) == 'suppliers') ?  'active' : '' ?> "
                                                                                                    href="<?php echo site_url('invoices/index/supplier'); ?>">
                                                                                                    <span class="menu-bullet">
                                                                                                        <span class="bullet bullet-dot"></span>
                                                                                                    </span>
                                                                                                    <span
                                                                                                        class="menu-title"><?php echo lang('purchase_invoice') ?></span>
                                                                                                </a>
                                                                                            </div>
                                                                                        ...
                                                                                        ?>
                                                                                                <div class="menu-item">
                                                                                                    <a class="menu-link  <?= ($this->uri->segment(3) == 'suppliers') ?  'active' : '' ?> "
                                                                                                        href="<?php echo site_url('invoices/zatca_invoice'); ?>">
                                                                                                        <span class="menu-bullet">
                                                                                                            <span class="bullet bullet-dot"></span>
                                                                                                        </span>
                                                                                                        <span
                                                                                                            class="menu-title"><?php echo lang('ZATCA') ?></span>
                                                                                                    </a>
                                                                                                </div>
                                                                                        ...
                                                                                        <?php if ($this->Employee->has_module_permission('suppliers', $employee_id)) { ?>
                                                                                            ...
                                                                                            <div class="menu-item">
                                                                                                <a class="menu-link  <?= ($this->uri->segment(1) == 'suppliers') ?  'active' : '' ?> "
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="menu-title"><?php echo lang('module_suppliers') ?></span>
                                                                                                </a>
                                                                                            </div>
                                                                                    ...
                                                                                    <?php if (check_allowed_module($allowed_modules->result(), 'receivings')) : ?>
                                                                                        <?php if ($this->Employee->has_module_permission('receivings', $employee_id)) { ?>
                                                                                            ...
                                                                                            <div class="menu-item">
                                                                                                <a class="menu-link  <?= ($this->uri->segment(2) == 'suspended') ?  'active' : '' ?> "
                                                                                                    href="<?php echo site_url('receivings/suspended'); ?>">
                                                                                                    <span class="menu-bullet">
                                                                                                        <span class="bullet bullet-dot"></span>
                                                                                                    </span>
                                                                                                    <span
                                                                                                        class="menu-title"><?php echo lang('suspended_receiving') ?></span>
                                                                                                </a>
                                                                                            </div>
                                                                                    ...
                                                                                    <?php else : ?>
                                                                                        ...
                                                                                        <span class="menu-link">
                                                                                            <span class="menu-icon">
                                                                                                <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/ecommerce/ecm008.svg-->
                                                                                                <span
                                                                                                    class="svg-icon svg-icon-muted svg-icon-2x"><svg
                                                                                                        width="24" height="24" viewBox="0 0 24 24"
                                                                                                        fill="none"
                                                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                                                        <path opacity="0.3"
                                                                                            ...
                                                                                            <?php if (!isset($is_pos)) : ?>
                                                                                                <span
                                                                                                    class="menu-title"><?php echo lang('stock'); ?></span>
                                                                                                <span class="menu-arrow"></span>
                                                                                            <?php endif; ?>
                                                                                            ...
                                                                                            <?php else : ?>
                                                                                                ...
                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'items')) : ?>
                                                                                                    <?php if ($this->Employee->has_module_permission('items', $this->Employee->get_logged_in_employee_info()->person_id)) : ?>
                                                                                                        ...
                                                                                                        <div class="menu-item">
                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'items' && $this->uri->segment(2) != 'manage_categories' && $this->uri->segment(2) != 'manage_modifiers'  && $this->uri->segment(2) != 'manage_tags' && $this->uri->segment(2) != 'manage_attributes'  && $this->uri->segment(2) != 'manage_manufacturers') ?  'active' : '' ?> "
                                                                                                                href="<?php echo site_url('items'); ?>">
                                                                                                                <span class="menu-bullet">
                                                                                                                    <span class="bullet bullet-dot"></span>
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    class="menu-title"><?php echo lang('module_items') ?></span>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                ...
                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'item_kits')) : ?>
                                                                                                    <?php if ($this->Employee->has_module_permission('item_kits', $this->Employee->get_logged_in_employee_info()->person_id)) : ?>
                                                                                                        ...
                                                                                                        <div class="menu-item">
                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'item_kits') ?  'active' : '' ?> "
                                                                                                                href="<?php echo site_url('item_kits'); ?>">
                                                                                                                <span class="menu-bullet">
                                                                                                                    <span class="bullet bullet-dot"></span>
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    class="menu-title"><?php echo lang('product_bundles') ?></span>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                ...
                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'items')) : ?>
                                                                                                    <?php if ($this->Employee->has_module_action_permission('items', 'manage_categories', $this->Employee->get_logged_in_employee_info()->person_id)) : ?>
                                                                                                        ...
                                                                                                        <div class="menu-item">
                                                                                                            <a class="menu-link  <?= ($this->uri->segment(2) == 'manage_categories') ?  'active' : '' ?> "
                                                                                                                href="<?php echo site_url('items/manage_categories'); ?>">
                                                                                                                <span class="menu-bullet">
                                                                                                                    <span class="bullet bullet-dot"></span>
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    class="menu-title"><?php echo lang('reports_categories') ?></span>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                ...
                                                                                                <div data-kt-menu-trigger="click"
                                                                                                    class="menu-item <?php echo ($this->uri->segment(2) == 'manage_categories' || $this->uri->segment(2) == 'manage_modifiers' || $this->uri->segment(2) == 'manage_tags'  || $this->uri->segment(2) == 'manage_attributes' || $this->uri->segment(2) == 'manage_manufacturers')  ? 'hover show' : ''; ?>  menu-accordion">
                                                                                                    <span class="menu-link"><span
                                                                                                            class="menu-bullet"><span
                                                                                                                class="bullet bullet-dot"></span></span><span
                                                                                                            class="menu-title"><?php echo lang('texonomy') ?></span><span
                                                                                                            class="menu-arrow"></span></span>


                                                                                                    <div class="menu-sub menu-sub-accordion"
                                                                                                        style="<?php echo ($this->uri->segment(2) == 'manage_categories' || $this->uri->segment(2) == 'manage_modifiers' || $this->uri->segment(2) == 'manage_tags'  || $this->uri->segment(2) == 'manage_attributes' || $this->uri->segment(2) == 'manage_manufacturers')  ? '' : 'display:none'; ?>  overflow: hidden;"
                                                                                                        kt-hidden-height="392">


                                                                                                        <?php if ($this->Employee->has_module_permission('items', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>

                                                                                                            <div class="menu-item">
                                                                                                                <a class="menu-link <?= ($this->uri->segment(2) == 'manage_modifiers') ?  'active' : '' ?>"
                                                                                                                    href="<?php echo site_url('items/manage_modifiers'); ?>">
                                                                                                                    <span class="menu-bullet">
                                                                                                                        <span
                                                                                                                            class="bullet bullet-dot"></span>
                                                                                                                    </span>
                                                                                                                    <span
                                                                                                                        class="menu-title"><?php echo lang("modifiers"); ?></span>
                                                                                                                </a>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <?php if ($this->Employee->has_module_action_permission('items', 'manage_tags', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                                                                                                            ...
                                                                                                            <div class="menu-item">
                                                                                                                <a class="menu-link <?= ($this->uri->segment(2) == 'manage_tags') ?  'active' : '' ?>"
                                                                                                                    href="<?php echo site_url('items/manage_tags'); ?>">
                                                                                                                    <span class="menu-bullet">
                                                                                                                        <span
                                                                                                                            class="bullet bullet-dot"></span>
                                                                                                                    </span>
                                                                                                                    <span
                                                                                                                        class="menu-title"><?php echo lang("tags"); ?></span>
                                                                                                                </a>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <?php if ($this->Employee->has_module_permission('items', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                                                                                                            ...
                                                                                                            <div class="menu-item">
                                                                                                                <a class="menu-link <?= ($this->uri->segment(2) == 'manage_attributes') ?  'active' : '' ?>"
                                                                                                                    href="<?php echo site_url('items/manage_attributes'); ?>">
                                                                                                                    <span class="menu-bullet">
                                                                                                                        <span
                                                                                                                            class="bullet bullet-dot"></span>
                                                                                                                    </span>
                                                                                                                    <span
                                                                                                                        class="menu-title"><?php echo lang("attributes"); ?></span>
                                                                                                                </a>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <?php if ($this->Employee->has_module_action_permission('items', 'manage_manufacturers', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                                                                                                            ...
                                                                                                            <div class="menu-item">
                                                                                                                <a class="menu-link  <?= ($this->uri->segment(2) == 'manage_manufacturers') ?  'active' : '' ?> "
                                                                                                                    href="<?php echo site_url('items/manage_manufacturers'); ?>">
                                                                                                                    <span class="menu-bullet">
                                                                                                                        <span
                                                                                                                            class="bullet bullet-dot"></span>
                                                                                                                    </span>
                                                                                                                    <span
                                                                                                                        class="menu-title"><?php echo lang('reports_manufacturers') ?></span>
                                                                                                                </a>
                                                                                                            </div>
                                                                                                ...
                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'receivings')) : ?>
                                                                                                    <?php if ($this->Employee->has_module_permission('receivings', $employee_id)) : ?>
                                                                                                        ...
                                                                                                        <div class="menu-item">
                                                                                                            <a class="menu-link  <?= ($this->uri->segment(2) == 'transfer') ?  'active' : '' ?> "
                                                                                                                href="<?php echo site_url('receivings/transfer'); ?>">
                                                                                                                <span class="menu-bullet">
                                                                                                                    <span class="bullet bullet-dot"></span>
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    class="menu-title"><?php echo lang('transfer') ?></span>
                                                                                                            </a>
                                                                                                        </div>
                                                                                            ...
                                                                                            <?php if (!isset($is_pos)) : ?>
                                                                                                ...
                                                                                                <?php else : ?>
                                                                                                    ...
                                                                                                    <span class="menu-link">
                                                                                                        ...
                                                                                                        <?php if (!isset($is_pos)) : ?>
                                                                                                            <span
                                                                                                                class="menu-title"><?php echo lang('promote'); ?></span>
                                                                                                            <span class="menu-arrow"></span>
                                                                                                        <?php endif; ?>
                                                                                                        ...
                                                                                                        <?php else : ?>
                                                                                                            ...
                                                                                                            <?php if (check_allowed_module($allowed_modules->result(), 'giftcards')) : ?>
                                                                                                                <?php if ($this->Employee->has_module_permission('giftcards', $employee_id)) { ?>
                                                                                                                    ...
                                                                                                                    <div class="menu-item">
                                                                                                                        <a class="menu-link  <?= ($this->uri->segment(1) == 'giftcards') ?  'active' : '' ?> "
                                                                                                                            href="<?php echo site_url('giftcards'); ?>">
                                                                                                                            <span class="menu-bullet">
                                                                                                                                <span
                                                                                                                                    class="bullet bullet-dot"></span>
                                                                                                                            </span>
                                                                                                                            <span
                                                                                                                                class="menu-title"><?php echo lang('module_giftcards') ?></span>
                                                                                                                        </a>
                                                                                                                    </div>
                                                                                                            ...
                                                                                                            <?php if (check_allowed_module($allowed_modules->result(), 'price_rules')) : ?>
                                                                                                                <?php if ($this->Employee->has_module_permission('price_rules', $employee_id)) { ?>
                                                                                                                    ...
                                                                                                                    <div class="menu-item">
                                                                                                                        <a class="menu-link  <?= ($this->uri->segment(1) == 'price_rules') ?  'active' : '' ?> "
                                                                                                                            href="<?php echo site_url('price_rules'); ?>">
                                                                                                                            <span class="menu-bullet">
                                                                                                                                <span
                                                                                                                                    class="bullet bullet-dot"></span>
                                                                                                                            </span>
                                                                                                                            <span
                                                                                                                                class="menu-title"><?php echo lang('module_price_rules') ?></span>
                                                                                                                        </a>
                                                                                                                    </div>
                                                                                                            ...
                                                                                                            <div class="menu-item "
                                                                                                                <?php echo array_search('items', $disable_modules) === false ? '' : 'style="display: none;"' ?>>
                                                                                                                <a class="menu-link  <?= ($this->uri->segment(2) == 'price_check') ?  'active' : '' ?> "
                                                                                                                    href="<?php echo site_url('items/price_check'); ?>">
                                                                                                                    <span class="menu-bullet">
                                                                                                                        <span
                                                                                                                            class="bullet bullet-dot"></span>
                                                                                                                    </span>
                                                                                                                    <span
                                                                                                                        class="menu-title"><?php echo lang('price_check') ?></span>
                                                                                                                </a>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <?php if ($this->Employee->has_module_permission('expenses', $employee_id)) { ?>
                                                                                                            <div class="menu-item admin_accordion"
                                                                                                                ...
                                                                                                                <a class="menu-link  <?= ($this->uri->segment(1) == 'expenses') ?  'active' : '' ?>"
                                                                                                                    ...
                                                                                                                    <?php if (!isset($is_pos)) : ?>
                                                                                                                        <span
                                                                                                                            class="menu-title"><?php echo lang('module_expenses') ?></span>
                                                                                                                    <?php endif; ?>
                                                                                                    ...
                                                                                                    <?php if (
                                                                                                        !check_allowed_module($allowed_modules->result(), 'reports') &&
                                                                                                        !check_allowed_module($allowed_modules->result(), 'notifications') &&
                                                                                                        !check_allowed_module($allowed_modules->result(), 'logs')
                                                                                                    ) {
                                                                                                    } else { ?>
                                                                                                        ...
                                                                                                        <?php if (!isset($is_pos)) : ?>
                                                                                                            ...
                                                                                                            <?php else : ?>
                                                                                                                ...
                                                                                                                <span class="menu-link">
                                                                                                                    ...
                                                                                                                    <?php if (!isset($is_pos)) : ?>
                                                                                                                        <span
                                                                                                                            class="menu-title"><?php echo lang('analytics_&_logs'); ?></span>
                                                                                                                        <span class="menu-arrow"></span>
                                                                                                                    <?php endif; ?>
                                                                                                                    ...
                                                                                                                    <?php else : ?>
                                                                                                                        ...
                                                                                                                        <?php if (check_allowed_module($allowed_modules->result(), 'reports')) : ?>
                                                                                                                            <?php if ($this->Employee->has_module_permission('reports', $employee_id)) { ?>
                                                                                                                                ...
                                                                                                                                <div class="menu-item">
                                                                                                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'reports') ?  'active' : '' ?> "
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            class="menu-title"><?php echo lang('reports') ?></span>
                                                                                                                                    </a>
                                                                                                                                </div>
                                                                                                                        ...
                                                                                                                        <div class="menu-item">
                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'notifications') ?  'active' : '' ?> "
                                                                                                                                ...
                                                                                                                                <span
                                                                                                                                    class="menu-title"><?php echo lang('notification_center') ?></span>
                                                                                                                            </a>
                                                                                                                        </div>

                                                                                                                        <div class="menu-item">
                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'logs') ?  'active' : '' ?> "
                                                                                                                                href="<?php echo site_url('logs'); ?>">
                                                                                                                                <span class="menu-bullet">
                                                                                                                                    <span
                                                                                                                                        class="bullet bullet-dot"></span>
                                                                                                                                </span>
                                                                                                                                <span
                                                                                                                                    class="menu-title"><?php echo lang('Activity_&_logs_viewer') ?></span>
                                                                                                                            </a>
                                                                                                                        </div>
                                                                                                                        ...
                                                                                                                        <div class="menu-item admin_accordion"
                                                                                                                            ...
                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'employees') ?  'active' : '' ?>"
                                                                                                                                ...
                                                                                                                                <span class="menu-icon">
                                                                                                                                    <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/communication/com013.svg-->
                                                                                                                                    <span
                                                                                                                                        class="svg-icon svg-icon-muted svg-icon-2x rotate-0"><svg
                                                                                                                                            width="24" height="24"
                                                                                                                                            viewBox="0 0 24 24"
                                                                                                                                            fill="none"
                                                                                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                                                                                ...
                                                                                                                                <?php if (!isset($is_pos)) : ?>
                                                                                                                                    <span
                                                                                                                                        class="menu-title"><?php echo lang('module_employees') ?></span>
                                                                                                                                <?php endif; ?>
                                                                                                                            </a>
                                                                                                                        </div>
                                                                                                                    ...
                                                                                                                    <?php if ($this->Employee->has_module_permission('locations', $employee_id)) { ?>
                                                                                                                        <div class="menu-item admin_accordion"
                                                                                                                            ...
                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'locations') ?  'active' : '' ?>"
                                                                                                                                ...
                                                                                                                                <?php if (!isset($is_pos)) : ?>
                                                                                                                                    <span
                                                                                                                                        class="menu-title"><?php echo lang('module_locations') ?></span>
                                                                                                                                <?php endif; ?>
                                                                                                                            </a>
                                                                                                                        </div>
                                                                                                                    ...
                                                                                                                    <?php if ($this->Employee->has_module_permission('messages', $employee_id)) { ?>
                                                                                                                        <div class="menu-item admin_accordion"
                                                                                                                            ...
                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'messages') ?  'active' : '' ?>"
                                                                                                                                ...
                                                                                                                                <?php if (!isset($is_pos)) : ?>
                                                                                                                                    <span
                                                                                                                                        class="menu-title"><?php echo lang('module_messages') ?></span>
                                                                                                                                <?php endif; ?>
                                                                                                                            </a>
                                                                                                                        </div>
                                    ...
                                    <div class="menu-item" >
                                        <a class="menu-link  <?= ($this->uri->segment(1) == 'payments') ?  'active': '' ?>"
                                                                            href="<?php echo site_url('payments'); ?>">
                                                                            <span class="menu-icon">
                                                                            ...
                                                                            <?php if(!isset($is_pos)): ?>
                                                                            <span
                                                                                class="menu-title"><?php echo lang('payments')?></span>
                                                                            <?php endif; ?>
                                                                            </a>
                                                                        </div>
                                                                                                                ...
                                                                                                                <?php if (!isset($is_pos)) : ?>
                                                                                                                    ...
                                                                                                                    <?php else : ?>
                                                                                                                        ...
                                                                                                                        <span class="menu-link">
                                                                                                                            ...
                                                                                                                            <?php if (!isset($is_pos)) : ?>
                                                                                                                                <span
                                                                                                                                    class="menu-title"><?php echo lang('setup'); ?></span>
                                                                                                                                <span class="menu-arrow"></span>
                                                                                                                            <?php endif; ?>
                                                                                                                            ...
                                                                                                                            <?php else : ?>
                                                                                                                                ...
                                                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'config')) : ?>
                                                                                                                                    <?php if ($this->Employee->has_module_permission('config', $employee_id)) { ?>
                                                                                                                                        <div class="menu-item"
                                                                                                                                            <?php echo array_search('config', $disable_modules) === false ? '' : 'style="display: none;"' ?>>
                                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'config' && $this->uri->segment(2) == '') ?  'active' : '' ?>"
                                                                                                                                                href="<?php echo site_url('config'); ?>">
                                                                                                                                                <span class="menu-icon">
                                                                                                                                                ...
                                                                                                                                                <span
                                                                                                                                                    class="menu-title"><?php echo lang('module_config') ?></span>
                                                                                                                                ...
                                                                                                                                <div class="menu-item">
                                                                                                                                    <a class="menu-link  <?= ($this->uri->segment(1) == 'language') ?  'active' : '' ?>"
                                                                                                                                        href="<?php echo site_url('language'); ?>">
                                                                                                                                        <span class="menu-icon">
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            class="menu-title"><?php echo lang('languages') ?></span>
                                                                                                                                ...
                                                                                                                                <?php if (check_allowed_module($allowed_modules->result(), 'receipt')) : ?>
                                                                                                                                    <?php if ($this->Employee->has_module_permission('receipt', $employee_id)) { ?>
                                                                                                                                        <div class="menu-item"
                                                                                                                                            <?php echo array_search('receipt', $disable_modules) === false ? '' : 'style="display: none;"' ?>>
                                                                                                                                            <a class="menu-link  <?= ($this->uri->segment(1) == 'receipt') ?  'active' : '' ?>"
                                                                                                                                                href="<?php echo site_url('receipt'); ?>">
                                                                                                                                                <span class="menu-icon">
                                                                                                                                                ...
                                                                                                                                                <span
                                                                                                                                                    class="menu-title"><?php echo lang('receipt') ?></span>
                                                                                                                                ...
                                                                                                                                <?php endif; ?>
                                                                                                                                <div class="menu-item">
                                                                                                                                    <a class="menu-link  <?= ($this->uri->segment(2) == 'backup') ?  'active' : '' ?>"
                                                                                                                                        href="<?php echo site_url('config/backup'); ?>">
                                                                                                                                        <span class="menu-icon">
                                                                                                                                            <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/maps/map001.svg-->
                                                                                                                                            <span
                                                                                                                                                class="ion-load-a">
                                                                                                                                        ...
                                                                                                                                        <span
                                                                                                                                            class="menu-title"><?php echo lang('backup_manager') ?></span>

                                                                                                                                    </a>
                                                                                                                                </div>
                                                                                                                                <?php if (!is_on_phppos_host()) { ?>
                                                                                                                                    <div class="menu-item">
                                                                                                                                        <a class="menu-link  checkForUpdate <?= ($this->uri->segment(2) == 'is_update_available') ?  'active' : '' ?>"
                                                                                                                                            href="<?php echo site_url('config/is_update_available'); ?>">
                                                                                                                                            <span class="menu-icon">
                                                                                                                                                <!--begin::Svg Icon | path: /Users/shuhratsaipov/www/keenthemes/products/core/html/src/media/icons/duotune/maps/map001.svg-->
                                                                                                                                                <span
                                                                                                                                            ...
                                                                                                                                            <span
                                                                                                                                                class="menu-title"><?php echo lang('system_update') ?></span>
                                                                                                                    ...
                                                                                                                    <!--end::Sidebar menu-->
                                                                                                                    <div
                                                                                                                        class="app-sidebar-user <?php if (!isset($is_pos)) : ?> d-flex  <?php else : ?> d-none <?php endif; ?> flex-stack py-5 px-8  cursor-pointer " data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                                            ...
                                                            class="fw-semibold text-muted text-hover-primary fs-7">Staff</a> -->
                                                                                                                                    ...
                                                                                                                                    <div class="menu-item px-5">
                                                                                                                                        <a tabindex="-1"
                                                                                                                                            ...
                                                                                                                                            href="<?php echo site_url('login/switch_user/' . ($this->uri->segment(1) == 'sales' ? '0' : '1'));  ?>"
                                                                                                                                            data-toggle="modal"
                                                                                                                                            data-target="#myModalDisableClose"
                                                                                                                                            class="menu-link px-5">
                                                                                                                                            <span
                                                                                                                                    ...
                                                                                                                                    ?>
                                                                                                                                        ...
                                                                                                                                        <div class="menu-item px-5">
                                                                                                                                              ...
                                                                                                                                              <?php
                                                                                                                                                                        echo anchor("timeclocks",  lang("employees_timeclock"), array('tabindex' => '-1' , 'class' => 'menu-link px-5'));
                                                                                                                                                                        ?>
