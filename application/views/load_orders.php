																...
																<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
																	...
																	<thead>
																		...
																		<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																			...
																			<th class="text-end min-w-70px">Time Remaining</th>
				...
				?>
					...
					?>
																		...
																		<tr>
																			...
																			<!--end::Status=-->
																			<!--begin::Status=-->
																			<?php if($order['sales']->order_status=='Processing'){ ?>
																				<td class="text-end pe-0" >
																				<!--begin::Badges-->
																				 <div class="remaing_time" data-id="<?php echo $order['sales']->sale_id ?>" data-totaltime="<?php echo $order['sales']->time_remaning ?>"> <?php echo $order['sales']->time_remaning ?> 	Min </div>
																				<!--end::Badges-->
																			</td>
																			<?php }elseif($order['sales']->order_status=='Completed'){ ?>
																				<td class="text-end pe-0" >
																				<!--begin::Badges-->
																				 <div class="remaing_time__" data-id="<?php echo $order['sales']->sale_id ?>" data-totaltime="<?php echo $order['sales']->time_remaning ?>"> <span class="badge badge-success">READY</span> </div>
																				<!--end::Badges-->
																			</td>
																		<?php 	}else{ ?>
																			...
																			<td class="text-end pe-0" >
																				<!--begin::Badges-->
																				 <div class="remaing_time__" data-id="<?php echo $order['sales']->sale_id ?>" data-totaltime="<?php echo $order['sales']->time_remaning ?>"> Not Started yet</div>
																				<!--end::Badges-->
																			</td>
																		<?php 	} ?>
