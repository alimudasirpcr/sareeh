...
$lang['config_backup_phpmyadmin_2'] = 'Nama pengguna Anda adalah root dan password adalah apa yang Anda gunakan selama instalasi awal %BRANDING_SHORT_NAME%. Setelah login pilih database Anda dari panel di sebelah kiri. Kemudian pilih ekspor dan kemudian menyerahkan formulir.';
...
$lang['config_import_ecommerce_items_into_phppos'] = 'Impor item ke %BRANDING_SHORT_NAME%';
...
$lang['config_import_ecommerce_categories_into_phppos'] = 'Impor kategori ke %BRANDING_SHORT_NAME%';
$lang['config_import_ecommerce_tags_into_phppos'] = 'Impor tag ke %BRANDING_SHORT_NAME%';
...
$lang['config_import_ecommerce_attributes_into_phppos'] = 'Impor atribut ke %BRANDING_SHORT_NAME%';
...
$lang['config_import_ecommerce_orders_into_phppos'] = 'Impor pesanan ke %BRANDING_SHORT_NAME%';
...
$lang['config_import_tax_classes_into_phppos'] = 'Mengimpor Kelas Pajak ke dalam %BRANDING_SHORT_NAME%';
$lang['config_export_tax_classes_into_phppos'] = 'Ekspor kelas pajak ke e-niaga';
$lang['config_import_shipping_classes_into_phppos'] = 'Impor Kelas Pengiriman ke %BRANDING_SHORT_NAME%';
...
$lang['config_import_quickbooks_items_into_phppos'] = 'Impor item ke dalam %BRANDING_SHORT_NAME%';
$lang['config_export_phppos_items_to_quickbooks'] = 'Ekspor barang ke buku cepat';
$lang['config_import_customers_into_phppos'] = 'Impor pelanggan ke %BRANDING_SHORT_NAME%';
$lang['config_import_suppliers_into_phppos'] = 'Pemasok impor ke %BRANDING_SHORT_NAME%';
$lang['config_import_employees_into_phppos'] = 'Impor karyawan ke %BRANDING_SHORT_NAME%';
...
$lang['config_show_supplier_in_item_search_result'] = 'Tampilkan Pemasok Dalam Hasil Pencarian Barang';
...
$lang['config_disabled_fixed_discounts'] = 'Nonaktifkan Seluruh Diskon Tetap Pada Antarmuka Penjualan';
...
$lang['hide_supplier_in_item_search_result'] = 'Sembunyikan Pemasok Di Hasil Pencarian Barang';

$lang['config_link_to_receipt'] = 'Tautan ke Tanda Terima';
$lang['config_sale_summary_info'] = 'Info Ringkasan Penjualan';
$lang['config_qr_code_format'] = 'Format Kode QR';
...
$lang['config_disable_signature_capture_on_terminal_for_phppos_credit_card_processing'] = 'Nonaktifkan Pengambilan Tanda Tangan untuk Pemrosesan Kartu Kredit POS PHP';


$lang['config_capture_internal_notes_during_receiving'] = 'Tangkap Catatan Internal Selama Menerima';


$lang['config_default_employee_for_deliveries'] = 'Karyawan Default untuk Pengiriman';

$lang['config_disable_verification_for_qr_codes'] = 'Nonaktifkan verifikasi untuk kode QR (Tidak memerlukan nomor telepon atau email)';


$lang['config_disable_variation_popup_in_receivings'] = 'Nonaktifkan Popup Variasi dalam Menerima';

$lang['config_saudi_arabia_digital_receipt'] = 'Tanda Terima Digital Arab Saudi';

$lang['config_scale_6'] = 'Kode Batang Tertanam Berat EAN 13';

$lang['config_hide_location_name_on_receipt'] = 'Sembunyikan Nama Lokasi Di Tanda Terima';
$lang['config_disable_discount_by_percentage'] = 'Nonaktifkan Seluruh Diskon Berdasarkan Persentase pada Antarmuka Penjualan';

$lang['Delivery ID'] = 'ID pengiriman';
$lang['config_scale_7'] = 'Berat Kode Batang Tertanam EAN 13 4 digit harga';

$lang['config_use_main_image_as_default_image_in_e_commerce'] = 'Gunakan Gambar Utama Sebagai Gambar Default Di E-Commerce';


$lang['config_disable_discounts_percentage_per_line_item'] = 'Nonaktifkan Persentase Diskon Per Item Baris';

$lang['config_create_invoices_for_customer_store_account_charges'] = 'Buat Faktur untuk biaya akun toko pelanggan';
$lang['config_create_invoices_for_supplier_store_account_charges'] = 'Buat faktur untuk biaya akun toko pemasok';




$lang['config_turn_on_review_requests'] = 'Aktifkan Permintaan Peninjauan';

$lang['config_additional_appointment_note'] = 'Catatan Janji Temu Tambahan';


$lang['config_hover_to_expand_sub_modules'] = 'Arahkan kursor untuk Memperluas Sub-Modul';
$lang['common_parties'] = 'Para Pihak';


$lang['config_send_sms_via_whatsapp'] = 'Kirim SMS Via Whatsapp';

$lang['config_additional_appointment_note'] = 'Catatan Janji Temu Tambahan';

$lang['config_keywords_help_text'] = 'Di sini, Anda dapat menggunakan beberapa kata kunci.';
...
$lang['config_keyword_modules'] = 'Modul';

$lang['config_allow_employees_to_use_2fa'] = 'Izinkan karyawan menggunakan 2FA (Otentikasi Dua Faktor)';


$lang['shopify_private_key'] = 'Kunci Pribadi Shopify';
$lang['shopify_public_key'] = 'Kunci Publik Shopify';
$lang['config_reconnect_to_shopify'] = 'Hubungkan kembali ke Shopify';


$lang['config_number_of_decimals_displayed_on_sales_interface'] = 'Jumlah Desimal yang Ditampilkan pada Antarmuka Penjualan';
...
$lang['config_easy_item_clone_button'] = 'Tombol Klon Item Mudah';

$lang['config_customer_allow_partial_match'] = 'Izinkan Pencocokan Sebagian Untuk Penelusuran Pelanggan';

$lang['config_ig_api_bearer_token'] = 'Token Pembawa API Gadget yang Terluka';
$lang['config_ig_integration'] = 'Integrasi Gadget yang Terluka';
$lang['config_wgp_integration_pkey'] = 'Kunci Mitra Integrasi WGP';
$lang['config_lookup_api_integration'] = 'Cari Integrasi API';
$lang['config_wgp_integration_userid'] = 'ID Pengguna Integrasi WGP';
$lang['config_work_order'] = 'Perintah kerja';
$lang['config_work_order_notes_internal'] = 'Catatan Internal Secara Default';
$lang['config_enable_quick_customers'] = 'Aktifkan Tambah/Perbarui Pelanggan Cepat';
$lang['config_enable_quick_suppliers'] = 'Aktifkan Tambah/Perbarui Pemasok Cepat';
$lang['config_enable_quick_items'] = 'Aktifkan Tambah/Perbarui Item Cepat';
$lang['config_enable_quick_expense'] = 'Aktifkan Tambah/Perbarui Pengeluaran Cepat';
$lang['config_hide_supplier_on_sales_interface'] = 'Sembunyikan Pemasok di Antarmuka Penjualan';
$lang['config_hide_supplier_on_recv_interface'] = 'Sembunyikan Pemasok di Antarmuka Penerimaan';
$lang['config_hide_supplier_from_item_popup'] = 'Sembunyikan Pemasok Dari Popup Item';
$lang['config_enable_ig_integration'] = 'Aktifkan Integrasi Gadget yang Terluka';
$lang['config_enable_wgp_integration'] = 'Aktifkan Integrasi Suku Cadang Gadget Grosir';


$lang['config_sso_info'] = 'Info Sistem Masuk Tunggal (SSO)';
$lang['config_sso_protocol'] = 'Protokol SSO';
$lang['config_saml'] = 'SAML';
$lang['config_oidc'] = 'OIDC';
$lang['config_saml_idp_entity_id'] = 'ID Entitas Penyedia Identitas (Metadata)';
$lang['config_saml_single_sign_on_service'] = 'URL Layanan Masuk Tunggal';
$lang['config_saml_single_logout_service'] = 'URL Layanan Keluar Tunggal';
$lang['config_saml_x509_cert'] = 'Sertifikat x509';
$lang['saml_idp_entity_id'] = 'ID Entitas Penyedia Identitas (Metadata)';
$lang['config_saml_name_id_format'] = 'Format ID Nama Saml';
$lang['config_saml_first_name_field'] = 'Nama Bidang Nama Depan';
$lang['config_saml_last_name_field'] = 'Nama Belakang Nama Bidang';
$lang['config_saml_email_field'] = 'Nama Bidang Email';
$lang['config_oidc_host'] = 'Tuan Rumah OIDC';
$lang['config_oidc_client_id'] = 'ID Klien OIDC';
$lang['config_oidc_secret'] = 'Rahasia OIDC';
$lang['config_oidc_cert_url'] = 'URL Sertifikat OIDC';
$lang['config_saml_groups_field'] = 'Nama Bidang Grup SAML';
$lang['config_oidc_groups_field'] = 'Bidang Grup OIDC';
$lang['config_oidc_additional_scopes'] = 'Lingkup Tambahan OIDC';
$lang['config_oidc_locations_field'] = 'Bidang Lokasi OIDC';
$lang['config_saml_locations_field'] = 'Bidang Lokasi SAML';
$lang['config_oidc_username_field'] = 'Bidang Nama Pengguna OIDC';
$lang['config_add_ck_editor'] = 'Tambahkan Editor CK';
$lang['config_add_ck_editor'] = 'Gunakan Editor HTML (Editor CK)';
$lang['config_do_not_allow_edit_of_overall_subtotal'] = 'Jangan Izinkan Pengeditan Subtotal Keseluruhan';
$lang['config_only_allow_sso_logins'] = 'Hanya Izinkan Login SSO';
$lang['config_enable_p4_integration'] = 'Aktifkan Integrasi Parts4Cells.com';
$lang['config_p4_api_bearer_token'] = 'Token Pembawa API Parts4cells.com';
$lang['config_work_order_note_status'] = 'Status Catatan Perintah Kerja';
$lang['config_work_order_device_locations'] = 'Lokasi Perangkat Perintah Kerja';




$lang['gmail_api_token_registered'] = 'PHP App Sales Manager sekarang berwenang untuk mengirim email atas nama akun gmail Anda. Anda dapat menutup jendela ini.';
$lang['gmail_api_token_removed'] = 'Token Anda telah dihapus.';
$lang['gmail_api_authorize'] = 'Mengizinkan';
$lang['gmail_api_refresh'] = 'Menyegarkan';
$lang['gmail_api_remove'] = 'Menghapus';
$lang['gmail_api_error'] = 'Kesalahan';
$lang['gmail_api_success'] = 'Kesuksesan';
$lang['gmail_api_authorize_require'] = 'Harap otorisasi akun google.';


$lang['config_automatically_email_invoice'] = 'Faktur Email Secara Otomatis';



$lang['config_disable_default_value_for_tracking_number'] = 'Nonaktifkan Nilai Default untuk Nomor Pelacakan';
$lang['config_disable_supplier_selection_on_sales_interface'] = 'Nonaktifkan Pilihan Pemasok Pada Antarmuka Penjualan';

$lang['config_allow_reorder_sales_receipt'] = 'Izinkan Pemesanan Ulang Pada Tanda Terima Penjualan';
$lang['config_allow_reorder_receiving_receipt'] = 'Izinkan Pemesanan Ulang saat Menerima Tanda Terima';
$lang['config_only_allow_current_location_customers'] = 'Hanya izinkan karyawan untuk mengatur pelanggan di lokasi mereka';
$lang['config_only_allow_current_location_employees'] = 'Hanya izinkan karyawan untuk melihat karyawan dengan lokasi';

$lang['config_hide_repair_items_in_sales_interface'] = 'Sembunyikan Item Perbaikan Di Antarmuka Penjualan';
$lang['config_hide_repair_items_on_receipt'] = 'Sembunyikan Item Perbaikan Pada Tanda Terima';
$lang['config_disable_name_prefix'] = 'Nonaktifkan Awalan Nama';
$lang['config_update_base_cost_price_from_units'] = 'Perbarui Biaya Dasar Dari Variasi Kuantitas Unit';


$lang['config_enable_name_prefix'] = 'Aktifkan Awalan Nama';


$lang['config_default_tech_is_logged_employee'] = 'Teknisi Bawaan Masuk';
$lang['config_default_workorder_tech_is_logged_employee'] = 'Teknisi Perintah Kerja Default Masuk';

$lang['config_create_work_order_for_customer'] = 'Buat Perintah Kerja untuk Pelanggan';


$lang['config_work_repair_item_taxable'] = 'Perbaikan Barang Kena Pajak';

$lang['config_override_estimate_name'] = 'Ganti Nama Estimasi';
$lang['config_override_employee_label_on_receipt'] = 'Ganti Label Karyawan Pada Tanda Terima';
$lang['config_remove_weight_from_receipt'] = 'Hapus Berat dari Tanda Terima';
$lang['config_show_item_description_service_tag'] = 'Tampilkan Deskripsi Item Tag Layanan';
$lang['config_show_phone_number_service_tag'] = 'Tampilkan Tag Layanan Nomor Telepon';
$lang['config_change_work_order_status_from_sales'] = 'Ubah Status Perintah Kerja dari Penjualan';
$lang['config_work_order_change_status_on_sales_complete'] = 'Ubah Status Perintah Kerja pada Penjualan Selesai';
$lang['config_do_not_change'] = 'Jangan berubah';
$lang['config_create_work_order_is_checked_by_default_for_sale'] = 'Buat Perintah Kerja Dicentang Secara Default Untuk Dijual';
$lang['config_remove_tax_percent_on_receipt'] = 'Hapus Persentase Pajak atas Penerimaan';
$lang['config_work_order_warranty_checked_product_price_zero'] = 'Harga Produk Nol jika Garansi Diperiksa';
?>