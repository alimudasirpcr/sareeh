...
$lang['config_backup_phpmyadmin_2'] = 'Il tuo nome utente è root e la password è quello che hai usato durante l\'installazione iniziale di %BRANDING_SHORT_NAME%. Una volta effettuato il login selezionare il database dal pannello di sinistra. Quindi selezionare l\'esportazione e poi inviare il modulo.';
...
$lang['config_import_ecommerce_items_into_phppos'] = 'Importa gli elementi in %BRANDING_SHORT_NAME%';
...
$lang['config_import_ecommerce_categories_into_phppos'] = 'Importa categorie in %BRANDING_SHORT_NAME%';
$lang['config_import_ecommerce_tags_into_phppos'] = 'Importa i tag in %BRANDING_SHORT_NAME%';
...
$lang['config_import_ecommerce_attributes_into_phppos'] = 'Importare gli attributi in %BRANDING_SHORT_NAME%';
...
$lang['import_ecommerce_orders_into_phppos'] = 'Importa ordini in %BRANDING_SHORT_NAME%';
...
$lang['config_delivery_color_based_on'] = 'Colore di consegna basato su';
$lang['config_delivery_color_based_on_status'] = 'Stato';
...
$lang['config_layaway_statement_message'] = 'Messaggio di istruzione Layaway';


$lang['config_show_supplier_in_item_search_result'] = 'Mostra fornitore nel risultato della ricerca articolo';
...
$lang['config_import_ecommerce_orders_suspended'] = 'Importa ordini e-commerce sospesi';

$lang['config_show_images_on_receipt'] = 'Mostra immagini alla ricezione';

$lang['config_disabled_fixed_discounts'] = 'Disattiva interi sconti fissi sull\'interfaccia di vendita';
...
$lang['hide_supplier_in_item_search_result'] = 'Nascondi fornitore nel risultato della ricerca articolo';

$lang['config_link_to_receipt'] = 'Link alla ricevuta';
$lang['config_sale_summary_info'] = 'Informazioni di riepilogo della vendita';
$lang['config_qr_code_format'] = 'Formato codice QR';
...
$lang['config_disable_signature_capture_on_terminal_for_phppos_credit_card_processing'] = 'Disabilita l\'acquisizione della firma per l\'elaborazione della carta di credito POS PHP';


$lang['config_capture_internal_notes_during_receiving'] = 'Acquisisci note interne durante la ricezione';


$lang['config_default_employee_for_deliveries'] = 'Impiegato predefinito per le consegne';

$lang['config_disable_verification_for_qr_codes'] = 'Disattiva la verifica per i codici QR (non è necessario un numero di telefono o un\'e-mail)';

$lang['config_disable_variation_popup_in_receivings'] = 'Disabilita il popup della variazione in ricezione';

$lang['config_saudi_arabia_digital_receipt'] = 'Ricevuta digitale dell\'Arabia Saudita';

$lang['config_scale_6'] = 'Peso Codice a barre integrato EAN 13';

$lang['config_hide_location_name_on_receipt'] = 'Nascondi il nome della posizione sulla ricevuta';
$lang['config_disable_discount_by_percentage'] = 'Disattiva interi sconti in percentuale sull\'interfaccia di vendita';

$lang['Delivery ID'] = 'ID consegna';
$lang['config_scale_7'] = 'Peso Codici a barre incorporati EAN 13 4 cifre del prezzo';

$lang['config_use_main_image_as_default_image_in_e_commerce'] = 'Usa l\'immagine principale come immagine predefinita nell\'e-commerce';


$lang['config_disable_discounts_percentage_per_line_item'] = 'Disattiva la percentuale di sconti per elemento pubblicitario';

$lang['config_create_invoices_for_customer_store_account_charges'] = 'Crea fatture per gli addebiti dell\'account del negozio del cliente';
$lang['config_create_invoices_for_supplier_store_account_charges'] = 'Creare fatture per gli addebiti dell\'account del negozio fornitore';




$lang['config_turn_on_review_requests'] = 'Attiva Richieste di revisione';

$lang['config_additional_appointment_note'] = 'Nota aggiuntiva per l\'appuntamento';


$lang['config_hover_to_expand_sub_modules'] = 'Passa il mouse per espandere i sottomoduli';
$lang['common_parties'] = 'Feste';


$lang['config_send_sms_via_whatsapp'] = 'Invia SMS tramite Whatsapp';

$lang['config_additional_appointment_note'] = 'Nota aggiuntiva per l\'appuntamento';

$lang['config_keywords_help_text'] = 'Qui puoi usare alcune parole chiave.';
...
$lang['config_keyword_modules'] = 'Moduli';

$lang['config_allow_employees_to_use_2fa'] = 'Consenti ai dipendenti di utilizzare 2FA (autenticazione a due fattori)';


$lang['shopify_private_key'] = 'Shopify Chiave privata';
$lang['shopify_public_key'] = 'Shopify Chiave pubblica';
$lang['config_reconnect_to_shopify'] = 'Riconnetti a Shopify';


$lang['config_number_of_decimals_displayed_on_sales_interface'] = 'Numero di decimali visualizzati sull\'interfaccia di vendita';
...
$lang['config_easy_item_clone_button'] = 'Pulsante Clona elemento facile';

$lang['config_customer_allow_partial_match'] = 'Consenti corrispondenza parziale per la ricerca dei clienti';

$lang['config_ig_api_bearer_token'] = 'Token al portatore dell\'API di gadget feriti';
$lang['config_ig_integration'] = 'Integrazione di gadget feriti';
$lang['config_wgp_integration_pkey'] = 'Chiave del partner di integrazione WGP';
$lang['config_lookup_api_integration'] = 'Integrazione API di ricerca';
$lang['config_wgp_integration_userid'] = 'ID utente integrazione WGP';
$lang['config_work_order'] = 'Ordine di lavoro';
$lang['config_work_order_notes_internal'] = 'Note interne per impostazione predefinita';
$lang['config_enable_quick_customers'] = 'Abilita aggiunta/aggiornamento rapido del cliente';
$lang['config_enable_quick_suppliers'] = 'Abilita aggiunta/aggiornamento rapido del fornitore';
$lang['config_enable_quick_items'] = 'Abilita l\'Aggiunta/Aggiornamento rapido degli articoli';
$lang['config_enable_quick_expense'] = 'Abilita l\'aggiunta/aggiornamento rapido delle spese';
$lang['config_hide_supplier_on_sales_interface'] = 'Nascondi fornitore nell\'interfaccia di vendita';
$lang['config_hide_supplier_on_recv_interface'] = 'Nascondi fornitore nell\'interfaccia di ricezione';
$lang['config_hide_supplier_from_item_popup'] = 'Nascondi fornitore dal popup articolo';
$lang['config_enable_ig_integration'] = 'Abilita l\'integrazione dei gadget danneggiati';
$lang['config_enable_wgp_integration'] = 'Abilita l\'integrazione di parti di gadget all\'ingrosso';


$lang['config_sso_info'] = 'Informazioni sull\'accesso singolo (SSO).';
$lang['config_sso_protocol'] = 'Protocollo SSO';
$lang['config_saml'] = 'SAML';
$lang['config_oidc'] = 'OIDC';
$lang['config_saml_idp_entity_id'] = 'ID entità provider di identità (metadati)';
$lang['config_saml_single_sign_on_service'] = 'URL del servizio di accesso singolo';
$lang['config_saml_single_logout_service'] = 'URL del servizio di disconnessione singolo';
$lang['config_saml_x509_cert'] = 'Certificato x509';
$lang['saml_idp_entity_id'] = 'ID entità provider di identità (metadati)';
$lang['config_saml_name_id_format'] = 'Formato ID nome Saml';
$lang['config_saml_first_name_field'] = 'Nome Nome campo';
$lang['config_saml_last_name_field'] = 'Cognome Nome campo';
$lang['config_saml_email_field'] = 'Nome campo e-mail';
$lang['config_oidc_host'] = 'OIDC ospite';
$lang['config_oidc_client_id'] = 'ID cliente OIDC';
$lang['config_oidc_secret'] = 'Segreto OIDC';
$lang['config_oidc_cert_url'] = 'URL certificato OIDC';
$lang['config_saml_groups_field'] = 'Nome campo Gruppi SAML';
$lang['config_oidc_groups_field'] = 'Campo Gruppi OIDC';
$lang['config_oidc_additional_scopes'] = 'Ambiti aggiuntivi OIDC';
$lang['config_oidc_locations_field'] = 'Campo Posizioni OIDC';
$lang['config_saml_locations_field'] = 'Campo Posizioni SAML';
$lang['config_oidc_username_field'] = 'Campo nome utente OIDC';
$lang['config_add_ck_editor'] = 'Aggiungi l\'editor CK';
$lang['config_add_ck_editor'] = 'Usa Editor HTML (Editor CK)';
$lang['config_do_not_allow_edit_of_overall_subtotal'] = 'Non consentire la modifica del totale parziale';
$lang['config_only_allow_sso_logins'] = 'Consenti solo accessi SSO';
$lang['config_enable_p4_integration'] = 'Abilita l\'integrazione di Parts4Cells.com';
$lang['config_p4_api_bearer_token'] = 'Token API di Parts4cells.com';
$lang['config_work_order_note_status'] = 'Stato della nota dell\'ordine di lavoro';
$lang['config_work_order_device_locations'] = 'Posizioni dei dispositivi dell\'ordine di lavoro';




$lang['gmail_api_token_registered'] = 'PHP App Sales Manager è ora autorizzato a inviare e-mail per conto del tuo account Gmail. Puoi chiudere questa finestra.';
$lang['gmail_api_token_removed'] = 'Il tuo token è stato rimosso.';
$lang['gmail_api_authorize'] = 'Autorizzare';
$lang['gmail_api_refresh'] = 'ricaricare';
$lang['gmail_api_remove'] = 'Rimuovere';
$lang['gmail_api_error'] = 'Errore';
$lang['gmail_api_success'] = 'Successo';
$lang['gmail_api_authorize_require'] = 'Si prega di autorizzare l\'account Google.';


$lang['config_automatically_email_invoice'] = 'Fattura automatica via e-mail';



$lang['config_disable_default_value_for_tracking_number'] = 'Disabilita il valore predefinito per il numero di tracciamento';
$lang['config_disable_supplier_selection_on_sales_interface'] = 'Disabilita la selezione del fornitore sull\'interfaccia di vendita';

$lang['config_allow_reorder_sales_receipt'] = 'Consenti riordino su ricevuta di vendita';
$lang['config_allow_reorder_receiving_receipt'] = 'Consenti riordino alla ricezione della ricevuta';
$lang['config_only_allow_current_location_customers'] = 'Consenti ai dipendenti solo di impostare i clienti nella loro posizione';
$lang['config_only_allow_current_location_employees'] = 'Consenti ai dipendenti di vedere solo il dipendente con la posizione';

$lang['config_hide_repair_items_in_sales_interface'] = 'Nascondi gli articoli di riparazione nell\'interfaccia di vendita';
$lang['config_hide_repair_items_on_receipt'] = 'Nascondi articoli da riparare al ricevimento';
$lang['config_disable_name_prefix'] = 'Disattiva il prefisso del nome';
$lang['config_update_base_cost_price_from_units'] = 'Aggiorna costo base da variazioni quantità unitaria';


$lang['config_enable_name_prefix'] = 'Abilita prefisso nome';


$lang['config_default_tech_is_logged_employee'] = 'Il tecnico predefinito è connesso';
$lang['config_default_workorder_tech_is_logged_employee'] = 'Il tecnico dell\'ordine di lavoro predefinito è connesso';

$lang['config_create_work_order_for_customer'] = 'Crea ordine di lavoro per il cliente';


$lang['config_work_repair_item_taxable'] = 'Oggetto di riparazione tassabile';

$lang['config_override_estimate_name'] = 'Sostituisci il nome del preventivo';
$lang['config_override_employee_label_on_receipt'] = 'Sostituisci etichetta dipendente al ricevimento';
$lang['config_remove_weight_from_receipt'] = 'Rimuovere il peso dalla ricevuta';
$lang['config_show_item_description_service_tag'] = 'Mostra articolo Descrizione Numero di matricola';
$lang['config_show_phone_number_service_tag'] = 'Mostra tag di matricola del numero di telefono';
$lang['config_change_work_order_status_from_sales'] = 'Modifica lo stato dell\'ordine di lavoro da Vendite';
$lang['config_work_order_change_status_on_sales_complete'] = 'Modifica lo stato dell\'ordine di lavoro al completamento delle vendite';
$lang['config_do_not_change'] = 'Non cambiare';
$lang['config_create_work_order_is_checked_by_default_for_sale'] = 'Crea ordine di lavoro è selezionato per impostazione predefinita per la vendita';
$lang['config_remove_tax_percent_on_receipt'] = 'Rimuovi la percentuale di imposta sulla ricevuta';
$lang['config_work_order_warranty_checked_product_price_zero'] = 'Prezzo del prodotto pari a zero se la garanzia è verificata';
?>