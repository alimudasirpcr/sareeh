...
class Inventory_low extends Report
{
	...
	public function getInputData()
	{
		...
		if ($this->settings['display'] == 'tabular')
		{
			...
			$input_params[] = array('view' => 'dropdown','dropdown_label' =>lang('inventory'),'dropdown_name' => 'inventory','dropdown_options' =>array('all' => lang('all'), 'in_stock' => lang('reports_in_stock'), 'out_of_stock' => lang('reports_out_of_stock'),'below_reorder_level' => lang('below_reorder_level'),'below_reorder_level_and_out_of_stock' => lang('below_reorder_level_and_out_of_stock'),),'dropdown_selected_value' => '');
	...
	public function getData()
	{
		...
		if ($this->params['category_id'])
		{
	        ...
	        $items_in = (!empty($item_ids))?'AND ( `phppos_items`.`item_id` IN('.$item_ids_string.') ) ':'and 1=2';
