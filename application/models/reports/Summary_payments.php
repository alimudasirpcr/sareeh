...
class Summary_payments extends Report
{
	...
	public function getInputData()
	{
		...
		if ($this->settings['display'] == 'tabular')
		{
			...
			$input_params = array(
				...
				array('view' => 'checkbox','checkbox_label' => lang('reports_only_count_store_account_payments'), 'checkbox_name' => 'only_count_store_account_payments'),
	...
	public function getData()
	{
		...
		if (isset($this->params['only_count_store_account_payments']) && $this->params['only_count_store_account_payments'])
		{
			$this->db->where('sales.store_account_payment',1);
		}
