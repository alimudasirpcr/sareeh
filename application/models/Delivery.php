...
class Delivery extends MY_Model
{
	...
	*/
	...
	function get_displayable_columns()
	{
		...
		return array(
			'sale_id' =>                           array('sort_column' => 'sales_deliveries.sale_id', 'label' => lang('sale_id'),'format_function' => 'sale_id_receipt_link_formatter','html' => TRUE),
			...
			'company_name' =>                      array('sort_column' => 'customer_sales_person.company_name', 'label' => lang('company')),
			'full_address' =>                      array('sort_column' => 'customer_person.address_1', 'label' => lang('address'), 'format_function' => 'address', 'html' => TRUE),
			'address_1' =>                         array('sort_column' => 'customer_person.address_1', 'label' => lang('address_1')),
			'address_2' =>                         array('sort_column' => 'customer_person.address_2', 'label' => lang('address_2')),
			...
			'country' =>                           array('sort_column' => 'customer_person.country', 'label' => lang('country')),
			...
			'status' =>                            array('sort_column' => 'sales_deliveries.status', 'label' => lang('status'), 'format_function' => 'delivery_status_badge', 'html' => TRUE),
			'comment' =>                           array('sort_column' => 'sales_deliveries.comment', 'label' => lang('comment')),
